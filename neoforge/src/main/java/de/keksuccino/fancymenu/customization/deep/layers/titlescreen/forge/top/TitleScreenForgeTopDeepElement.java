...
public class TitleScreenForgeTopDeepElement extends AbstractDeepElement {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        if (isEditor()) {
            ...
            graphics.drawCenteredString(font, line1, getScreenWidth() / 2, 4 + (0 * (font.lineHeight + 1)), DrawableColor.WHITE.getColorIntWithAlpha(this.opacity));
            ...
            graphics.drawCenteredString(font, line2, getScreenWidth() / 2, 4 + (1 * (font.lineHeight + 1)), DrawableColor.WHITE.getColorIntWithAlpha(this.opacity));
