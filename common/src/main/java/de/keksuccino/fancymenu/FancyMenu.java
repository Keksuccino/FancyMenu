...
public class FancyMenu {
    ...
    //TODO Machen, dass deprecated menu backgrounds einen "[Deprecated]" suffix haben

    //TODO Machen, dass deprecated menu background types nicht in context menu angezeigt werden, wenn sie nicht enabled sind (verschwinden, sobald disabled)
