...
public class SmoothFonts {
    ...
    private static final ResourceLocation NOTO_SANS_KR = new ResourceLocation("fancymenu", "fonts/noto_sans/noto_sans_kr.ttf");
    private static final ResourceLocation NOTO_SANS_SC = new ResourceLocation("fancymenu", "fonts/noto_sans/noto_sans_sc.ttf");
    private static final ResourceLocation NOTO_SANS_TC = new ResourceLocation("fancymenu", "fonts/noto_sans/noto_sans_tc.ttf");
    private static final ResourceLocation NOTO_SANS_EMOJI = new ResourceLocation("fancymenu", "fonts/noto_sans/noto_sans_emoji.ttf");
