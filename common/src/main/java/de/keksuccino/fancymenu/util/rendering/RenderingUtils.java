...
public class RenderingUtils {
    ...
    private static void innerBlit(GuiGraphics graphics, ResourceLocation location, float $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
        ...
        builder.vertex($$10, $$1, $$3, $$5).uv($$6, $$8).endVertex();
        builder.vertex($$10, $$1, $$4, $$5).uv($$6, $$9).endVertex();
        builder.vertex($$10, $$2, $$4, $$5).uv($$7, $$9).endVertex();
        builder.vertex($$10, $$2, $$3, $$5).uv($$7, $$8).endVertex();
        builder.end();
        BufferUploader.end(builder);
    }
