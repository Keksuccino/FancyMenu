...
public interface LocalizedEnum<E> extends NamedEnum<E> {
    ...
    Supplier<Style> SUCCESS_TEXT_STYLE = () -> Style.EMPTY.withColor(UIBase.getUITheme().success_color.getColorInt());
    Supplier<Style> WARNING_TEXT_STYLE = () -> Style.EMPTY.withColor(UIBase.getUITheme().warning_color.getColorInt());
    Supplier<Style> ERROR_TEXT_STYLE = () -> Style.EMPTY.withColor(UIBase.getUITheme().error_color.getColorInt());
