...
public class DrawableColor {
    ...
    public void setAsShaderColor(@NotNull GuiGraphicsExtractor graphics, float alpha) {
        FloatColor c = this.getAsFloats();
        de.keksuccino.fancymenu.util.rendering.RenderingUtils.setShaderColor(graphics, c.red(), c.green(), c.blue(), alpha);
    }

    public void setAsShaderColor(@NotNull GuiGraphicsExtractor graphics) {
        FloatColor c = this.getAsFloats();
        de.keksuccino.fancymenu.util.rendering.RenderingUtils.setShaderColor(graphics, c.red(), c.green(), c.blue(), c.alpha());
    }

    public void resetShaderColor(@NotNull GuiGraphicsExtractor graphics) {
