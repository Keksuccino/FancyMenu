...
public final class SmoothRectangleRenderer {
    ...
    private static void drawQuad_FancyMenu(@Nonnull QuadBounds bounds) {
        ...
        builder.addVertex(IDENTITY_POSE_FANCYMENU, bounds.minX(), bounds.minY(), 0.0F);
        builder.addVertex(IDENTITY_POSE_FANCYMENU, bounds.minX(), bounds.maxY(), 0.0F);
        builder.addVertex(IDENTITY_POSE_FANCYMENU, bounds.maxX(), bounds.maxY(), 0.0F);
        builder.addVertex(IDENTITY_POSE_FANCYMENU, bounds.maxX(), bounds.minY(), 0.0F);
