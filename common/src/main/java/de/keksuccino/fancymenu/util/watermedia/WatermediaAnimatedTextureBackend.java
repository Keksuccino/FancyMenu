...
public class WatermediaAnimatedTextureBackend implements AutoCloseable {
    ...
    public WatermediaAnimatedTextureBackend(@NotNull String uniqueId, @NotNull String typeName) {
        ...
        this.frameLocation = new ResourceLocation("fancymenu", "watermedia_" + cleanType + "_frame_" + cleanId);
    }
    ...
    public ResourceLocation getResourceLocation() {
        ...
        if (this.frameTexture.getId() <= 0) return RenderableResource.FULLY_TRANSPARENT_TEXTURE;
