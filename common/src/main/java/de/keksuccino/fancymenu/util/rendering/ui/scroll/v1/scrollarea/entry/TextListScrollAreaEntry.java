...
public class TextListScrollAreaEntry extends ScrollAreaEntry {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        graphics.drawString(this.font, this.text, (this.getX() + 5 + 4 + 3), (centerY - (this.font.lineHeight / 2)), UIBase.getUITheme().ui_interface_generic_text_color.getColorInt(), false);
