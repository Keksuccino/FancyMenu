...
public final class SmoothCircleRenderer {
    ...
    private static final String CIRCLE_INFO_0_NAME_FANCYMENU = "CircleInfo0";
    private static final String CIRCLE_INFO_1_NAME_FANCYMENU = "CircleInfo1";
    private static final String CIRCLE_INFO_2_NAME_FANCYMENU = "CircleInfo2";
    private static final VertexFormat SMOOTH_CIRCLE_VERTEX_FORMAT_FANCYMENU = VertexFormat.builder(0)
            ...
            .addAttribute(CIRCLE_INFO_0_NAME_FANCYMENU, GpuFormat.RGBA32_FLOAT)
            .addAttribute(CIRCLE_INFO_1_NAME_FANCYMENU, GpuFormat.RGBA32_FLOAT)
            .addAttribute(CIRCLE_INFO_2_NAME_FANCYMENU, GpuFormat.RGBA32_FLOAT)
            .build();
    private static final VertexFormatElement CIRCLE_INFO_0_FANCYMENU = getVertexFormatElement_FancyMenu(SMOOTH_CIRCLE_VERTEX_FORMAT_FANCYMENU, CIRCLE_INFO_0_NAME_FANCYMENU);
    ...
    private static final RenderPipeline SMOOTH_CIRCLE_PIPELINE_FANCYMENU = RenderPipeline.builder().withBindGroupLayout(BindGroupLayouts.GLOBALS)
            ...
            .withVertexBinding(0, SMOOTH_CIRCLE_VERTEX_FORMAT_FANCYMENU)
