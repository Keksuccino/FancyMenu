...
final class WeakSoundEngineReloadCoordinator<T> {
    ...
    void beforeReload() {
        ...
        this.dispatch(participants, this.beforeReloadAction, ReloadPhase.BEFORE);
    ...
    void afterReload() {
        ...
        this.dispatch(participants, this.afterReloadAction, ReloadPhase.AFTER);
    ...
    @NotNull
    private List<T> snapshotParticipants() {
    ...
    private void dispatch(@NotNull List<T> participants, @NotNull Consumer<T> action, @NotNull ReloadPhase phase) {
