...
public class FireworksOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    private void renderRockets(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight) {
    ...
    private void renderExplosions(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight) {
        if (this.explosions.isEmpty()) {
            return;
        }
    ...
    private void renderLine(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight, float x1, float y1, float x2, float y2, int alpha, int rgb, int thickness) {
        float dx = x2 - x1;
        float dy = y2 - y1;
