...
public class TextInputScreen extends Screen {
    ...
    public TextInputScreen(@NotNull Component title, @Nullable CharacterFilter filter, @NotNull Consumer<String> callback) {
        ...
        this.input = new ExtendedEditBox(Minecraft.getInstance().font, 0, 0, 200, 20, Components.empty());
    ...
    protected void init() {
        ...
        this.cancelButton = new ExtendedButton(0, 0, 100, 20, Components.translatable("fancymenu.guicomponents.cancel"), (button) -> {
            this.callback.accept(null);
        });
        this.addWidget(this.cancelButton);
        UIBase.applyDefaultWidgetSkinTo(this.cancelButton);

        this.doneButton = new ExtendedButton(0, 0, 100, 20, Components.translatable("fancymenu.guicomponents.done"), (button) -> {
