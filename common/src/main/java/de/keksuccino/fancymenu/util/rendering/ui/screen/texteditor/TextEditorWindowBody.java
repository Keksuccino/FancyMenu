...
public class TextEditorWindowBody extends PiPWindowBody {
    ...
    protected void tickMouseHighlighting(double mouseX, double mouseY, boolean allowAutoScroll) {
        ...
        double selectionMouseX = TextEditorMouseSelectionController.clampEndpoint(mouseX, this.borderLeft, this.getEditorAreaX() + this.getEditorAreaWidth());
        double selectionMouseY = TextEditorMouseSelectionController.clampEndpoint(mouseY, this.headerHeight, this.height - this.footerHeight);
    ...
    protected TextEditorLine getClosestVisibleLineAtY(double mouseY) {
        ...
        int lineIndex = TextEditorMouseSelectionController.findClosestVisibleLineIndex(this.textFieldLines, mouseY, editorTop, editorBottom, TextEditorLine::getY, TextEditorLine::getHeight);
        return lineIndex >= 0 ? this.textFieldLines.get(lineIndex) : null;
    }
    ...
    protected void validateMouseHighlightingCapture() {
        ...
        boolean windowVisible = !hasWindow || window.isVisible();
        boolean windowInputLocked = hasWindow && window.isInputLocked();
        boolean windowFocused = !hasWindow || PiPWindowHandler.INSTANCE.isWindowFocused(window);
        ...
        if (!TextEditorMouseSelectionController.isCaptureValid(hasWindow, windowVisible, windowInputLocked, windowFocused, leftMouseDown)) {
