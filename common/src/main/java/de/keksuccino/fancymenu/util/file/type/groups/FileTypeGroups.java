...
public class FileTypeGroups {
    ...
    public static final Component IMAGE_GROUP_COMPONENT = new TranslatableComponent("fancymenu.file_types.groups.image");
    public static final Component AUDIO_GROUP_COMPONENT = new TranslatableComponent("fancymenu.file_types.groups.audio");
    public static final Component VIDEO_GROUP_COMPONENT = new TranslatableComponent("fancymenu.file_types.groups.video");
    public static final Component TEXT_GROUP_COMPONENT = new TranslatableComponent("fancymenu.file_types.groups.text");
