...
public class ManageResourcePreLoadScreen extends CellScreen {
    ...
    protected void initCells() {
        ...
        for (ResourceSource source : ResourcePreLoader.getRegisteredResourceSources(this.cachedSerialized)) {
            ...
            this.addLabelCell(Components.literal(sourceString).setStyle(Style.EMPTY.withColor(UIBase.getUIColorTheme().element_label_color_normal.getColorInt())))
    ...
    protected void initRightSideWidgets() {
        ...
        this.addRightSideButton(20, Components.translatable("fancymenu.resources.pre_loading.manage.add.panorama"), extendedButton -> {
        ...
        this.addRightSideButton(20, Components.translatable("fancymenu.resources.pre_loading.manage.add.slideshow"), extendedButton -> {
