...
public class BrowserVideoSettings {

    public static final File SETTINGS_FILE = new File(FancyMenu.INSTANCE_DATA_DIR, "/browser_video_settings.json");
    ...
    private static void read() {
        try {
            ...
            LOGGER.error("[FANCYMENU] Failed to read browser video settings!", ex);
        }
    }
    ...
    private static void write() {
        try {
            ...
            LOGGER.error("[FANCYMENU] Failed to write browser video settings!", ex);
        }
    }
