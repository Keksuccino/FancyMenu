...
public class RinkuVideoPlayer {
    ...
    private static final ScheduledExecutorService PLAYBACK_LISTENER_EXECUTOR = FancyMenuExecutors.newSingleThreadScheduledExecutor("FancyMenu-RinkuVideoPlayer-PlaybackListener");
