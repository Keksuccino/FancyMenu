...
public final class GuiTextureCoverRenderer {
     ...
     */
    public static boolean render(@Nonnull GuiGraphicsExtractor graphics, @Nonnull RenderableResource resource, int x, int y, int width, int height) {
     ...
     */
    public static boolean render(@Nonnull GuiGraphicsExtractor graphics, @Nonnull Identifier location, int x, int y, int width, int height, int textureWidth, int textureHeight) {
        Objects.requireNonNull(graphics);
    ...
    static CoverBounds calculateBounds(int x, int y, int width, int height, int textureWidth, int textureHeight) {
        ...
        // requested GUI area, which GuiGraphicsExtractor intersects with the GUI viewport and any outer scissor.
