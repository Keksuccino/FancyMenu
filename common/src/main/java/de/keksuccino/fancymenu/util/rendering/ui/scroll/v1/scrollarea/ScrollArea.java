...
public class ScrollArea extends UIBase {
    ...
    public Color backgroundColor = UIBase.getUITheme().ui_interface_area_background_color_type_1.getColor();
    public Color borderColor = UIBase.getUITheme().ui_interface_area_border_color.getColor();
    ...
    public ScrollArea(int x, int y, int width, int height) {
        ...
        this.verticalScrollBar = new ScrollBar(ScrollBar.ScrollBarDirection.VERTICAL, VERTICAL_SCROLL_BAR_WIDTH, VERTICAL_SCROLL_BAR_HEIGHT, 0, 0, 0, 0, UIBase.getUITheme().scroll_grabber_color_normal.getColor(), UIBase.getUITheme().scroll_grabber_color_hover.getColor());
        this.verticalScrollBar.setScrollWheelAllowed(true);
        this.horizontalScrollBar = new ScrollBar(ScrollBar.ScrollBarDirection.HORIZONTAL, HORIZONTAL_SCROLL_BAR_WIDTH, HORIZONTAL_SCROLL_BAR_HEIGHT, 0, 0, 0, 0, UIBase.getUITheme().scroll_grabber_color_normal.getColor(), UIBase.getUITheme().scroll_grabber_color_hover.getColor());
