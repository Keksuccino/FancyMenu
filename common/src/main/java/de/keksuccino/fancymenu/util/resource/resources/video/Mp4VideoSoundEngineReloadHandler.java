...
public final class Mp4VideoSoundEngineReloadHandler {
    ...
    private static final WeakSoundEngineReloadCoordinator<Mp4Video> COORDINATOR = new WeakSoundEngineReloadCoordinator<>(Mp4Video::releasePlayerBeforeSoundEngineReload, Mp4Video::retryPlayerAfterSoundEngineReload, Mp4VideoSoundEngineReloadHandler::logFailure_FancyMenu);
    ...
    private static void logFailure_FancyMenu(@NotNull Mp4Video video, @NotNull WeakSoundEngineReloadCoordinator.ReloadPhase phase, @NotNull Throwable throwable) {
