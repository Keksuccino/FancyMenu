...
public class MarkdownTextFragment implements Renderable, GuiEventListener {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        if (this.imageSupplier != null) {
            ...
            try {
                // Minecraft 1.21.1 vanilla text drawing only accepts integer coordinates. Translate to the exact fragment origin and draw at local zero so fractional scaling cannot shift glyphs into the parent scissor area.
    ...
    public float getTextRenderX() {
        float scale = this.getScale();
        return MarkdownTextPositioning.toLocalCoordinate(this.getTextX(), scale);
    }
    ...
    public float getTextRenderY() {
        float scale = this.getScale();
        return MarkdownTextPositioning.toLocalCoordinate(this.getTextY(), scale);
    }
    ...
    public float getTextX() {
        return MarkdownTextPositioning.resolveTextOrigin(this.x, this.getTextRenderOffsetX(), this.getScale());
    }

    public float getTextY() {
        return MarkdownTextPositioning.resolveTextOrigin(this.y, this.getTextRenderOffsetY(), this.getScale());
    }
    ...
    public float getScale() {
        ...
        return MarkdownTextPositioning.sanitizeScale(f * this.parent.textBaseScale);
    }
