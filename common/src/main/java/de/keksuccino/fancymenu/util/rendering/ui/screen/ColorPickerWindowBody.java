...
public class ColorPickerWindowBody extends PiPWindowBody {
    ...
    private void renderLeftPanel(@NotNull GuiGraphicsExtractor graphics, @NotNull UITheme theme) {
    ...
    private void renderInfoPanel(@NotNull GuiGraphicsExtractor graphics, @NotNull UITheme theme) {
    ...
    private void renderColorArea(@NotNull GuiGraphicsExtractor graphics) {
    ...
    private void renderColorAreaSelector(@NotNull GuiGraphicsExtractor graphics, @NotNull UITheme theme) {
    ...
    private void renderHueSlider(@NotNull GuiGraphicsExtractor graphics, @NotNull UITheme theme) {
        int segments = 6;
    ...
    private void renderAlphaSlider(@NotNull GuiGraphicsExtractor graphics, @NotNull UITheme theme) {
    ...
    private void renderCheckerboard(@NotNull GuiGraphicsExtractor graphics, int x, int y, int width, int height, int cellSize) {
    ...
    private void fillGradientHorizontal(@NotNull GuiGraphicsExtractor graphics, int x1, int y1, int x2, int y2, int colorLeft, int colorRight) {
