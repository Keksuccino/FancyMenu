...
/**
 * Optimized FMA decoder that keeps frames in memory as direct ByteBuffers
 * ready for zero-copy OpenGL upload, similar to how MCEF handles browser frames.
 */
public class FmaDecoderOptimized implements Closeable {
