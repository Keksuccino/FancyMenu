...
public final class SmoothImageCircleRenderer {
    ...
    private static void _renderSmoothImageCircle(GuiGraphics graphics, float partial, CircleArea area) {
        ...
        applyUniforms(postChain, area.textureRegion, scaledX, scaledY, scaledWidth, scaledHeight, scaledRoundness, red, green, blue, alpha, textureId);
    ...
    private static void applyUniforms(PostChain postChain, TextureRegion textureRegion, float x, float y, float width, float height, float roundness, float red, float green, float blue, float alpha, int textureId) {
