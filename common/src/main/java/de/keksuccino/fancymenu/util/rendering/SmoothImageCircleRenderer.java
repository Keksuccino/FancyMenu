...
public final class SmoothImageCircleRenderer {
    ...
    private static final ResourceLocation GUI_SMOOTH_IMAGE_CIRCLE_POST_CHAIN = new ResourceLocation("minecraft", "shaders/post/fancymenu_gui_smooth_image_circle.json");
