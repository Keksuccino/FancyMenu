...
public class SunshineOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    private void renderSunRays(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight, SunBasis basis, float intensity) {
    ...
    private void renderRay(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight, float originX, float originY, float dirX, float dirY, float length, float width, int alpha, int rgb) {
