...
public class RainOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    private void renderRaindrops(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight) {
        for (Raindrop drop : this.raindrops) {
    ...
    private void renderPuddles(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight) {
    ...
    private void renderDrips(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight) {
    ...
    private void renderThunder(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight) {
