...
public class WebUtils {
    ...
    private static FixedDelayScheduler createConnectivityScheduler() {
        return new ExecutorFixedDelayScheduler(Executors.newSingleThreadScheduledExecutor(WebUtils::createConnectivityThread));
    }

    private static Thread createConnectivityThread(Runnable runnable) {
