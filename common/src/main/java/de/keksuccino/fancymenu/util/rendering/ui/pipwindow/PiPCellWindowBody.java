...
public abstract class PiPCellWindowBody extends CellScreen implements PipableScreen {
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollDeltaX, double scrollDeltaY) {
        return dispatchMouseScrolled(this.children(), mouseX, mouseY, scrollDeltaX, scrollDeltaY);
    }

    static boolean dispatchMouseScrolled(@NotNull Iterable<? extends GuiEventListener> listeners, double mouseX, double mouseY, double scrollDeltaX, double scrollDeltaY) {
