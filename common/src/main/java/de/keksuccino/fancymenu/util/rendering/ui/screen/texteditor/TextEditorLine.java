...
public class TextEditorLine extends ExtendedEditBox {
    ...
    public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        if (this.isVisible()) {
            ...
            int textColorInt = this.getAsAccessor().getIsEditableFancyMenu() ? this.getAsAccessor().getTextColorFancyMenu() : this.getAsAccessor().getTextColorUneditableFancyMenu();
