...
public class UITooltip implements Renderable {
    ...
    public void extractRenderState(@NotNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partial) {
        ...
        if (!this.isEmpty() && (screen != null)) {
            ...
            this.extractBackground(graphics, x, y, partial, scale);
    ...
    protected void extractBackground(GuiGraphicsExtractor graphics, int x, int y, float partial, float renderScale) {
        ...
        if (blurEnabled) {
            ...
            SmoothRectangleRenderer.renderSmoothRectRoundAllCorners(
                    ...
                    smoothCornerRadius,
                    smoothCornerRadius,
                    UIBase.getUITheme().ui_tooltip_background_color.getColorInt(),
                    partial
            );
        }

        int borderColorInt = blurEnabled ? UIBase.getUITheme().ui_blur_overlay_border_color.getColorInt() : UIBase.getUITheme().ui_overlay_border_color.getColorInt();
