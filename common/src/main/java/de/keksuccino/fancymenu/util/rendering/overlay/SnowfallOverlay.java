...
public class SnowfallOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    public void setColor(int color) {
        ...
        if (!this.snowflakes.isEmpty()) {
            ...
            for (Snowflake flake : this.snowflakes) {
                int alpha = ARGB.alpha(flake.color);
    ...
    private void renderAccumulation(GuiGraphicsExtractor graphics, int overlayX, int overlayY, int overlayWidth, int overlayHeight) {
    ...
    private void renderAccumulationArea(GuiGraphicsExtractor graphics, AccumulationArea area, int overlayX, int overlayY, int overlayWidth, int overlayHeight) {
        if (!area.isValid()) {
            return;
        }
    ...
    private void updateAccumulationColor() {
        ...
        int baseAlpha = ARGB.alpha(ACCUMULATION_COLOR);
