...
public abstract class ScrollAreaEntry extends UIBase implements Renderable {
    ...
    protected Color backgroundColorIdle = UIBase.getUITheme().ui_interface_area_background_color_type_1.getColor();
    protected Color backgroundColorHover = UIBase.getUITheme().ui_interface_area_entry_selected_color.getColor();
