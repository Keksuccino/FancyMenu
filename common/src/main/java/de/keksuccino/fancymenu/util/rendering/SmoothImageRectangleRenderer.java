...
public final class SmoothImageRectangleRenderer {
    ...
    private static void _renderSmoothImageRect(GuiGraphics graphics, float partial, RectArea area) {
        ...
        applyUniforms(postChain, area.textureRegion, scaledX, scaledY, scaledWidth, scaledHeight, scaledRadii, red, green, blue, alpha, textureId);
    ...
    private static void applyUniforms(PostChain postChain, TextureRegion textureRegion, float x, float y, float width, float height, CornerRadii cornerRadii, float red, float green, float blue, float alpha, int textureId) {
