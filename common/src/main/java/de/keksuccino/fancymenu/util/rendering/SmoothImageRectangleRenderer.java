...
public final class SmoothImageRectangleRenderer {
    ...
    private static final ResourceLocation GUI_SMOOTH_IMAGE_RECT_POST_CHAIN = ResourceLocation.withDefaultNamespace("shaders/post/fancymenu_gui_smooth_image_rect.json");
    ...
    public static void renderSmoothImageRect(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float cornerRadius, int color, float partial) {
    ...
    public static void renderSmoothImageRectScaled(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float cornerRadius, int color, float partial) {
        ...
        renderSmoothImageRect(graphics, texture, x * additionalScale + translationX, y * additionalScale + translationY, width * additionalScale, height * additionalScale, cornerRadius * additionalScale, color, partial);
    }

    public static void renderSmoothImageRect(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float uOffset, float vOffset, float uWidth, float vHeight, float textureWidth, float textureHeight, float cornerRadius, int color, float partial) {
    ...
    public static void renderSmoothImageRectScaled(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float uOffset, float vOffset, float uWidth, float vHeight, float textureWidth, float textureHeight, float cornerRadius, int color, float partial) {
        float additionalScale = resolveAdditionalRenderScale();
        float translationX = resolveAdditionalRenderTranslationX();
        float translationY = resolveAdditionalRenderTranslationY();
        renderSmoothImageRect(graphics, texture, x * additionalScale + translationX, y * additionalScale + translationY, width * additionalScale, height * additionalScale, uOffset, vOffset, uWidth, vHeight, textureWidth, textureHeight, cornerRadius * additionalScale, color, partial);
    }

    public static void renderSmoothImageRectRoundTopCorners(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float cornerRadius, int color, float partial) {
    ...
    public static void renderSmoothImageRectRoundTopCornersScaled(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float cornerRadius, int color, float partial) {
        float additionalScale = resolveAdditionalRenderScale();
        float translationX = resolveAdditionalRenderTranslationX();
        float translationY = resolveAdditionalRenderTranslationY();
        renderSmoothImageRectRoundTopCorners(graphics, texture, x * additionalScale + translationX, y * additionalScale + translationY, width * additionalScale, height * additionalScale, cornerRadius * additionalScale, color, partial);
    }

    public static void renderSmoothImageRectRoundBottomCorners(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float cornerRadius, int color, float partial) {
    ...
    public static void renderSmoothImageRectRoundBottomCornersScaled(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float cornerRadius, int color, float partial) {
        float additionalScale = resolveAdditionalRenderScale();
        float translationX = resolveAdditionalRenderTranslationX();
        float translationY = resolveAdditionalRenderTranslationY();
        renderSmoothImageRectRoundBottomCorners(graphics, texture, x * additionalScale + translationX, y * additionalScale + translationY, width * additionalScale, height * additionalScale, cornerRadius * additionalScale, color, partial);
    }

    public static void renderSmoothImageRectRoundAllCorners(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float topLeftRadius, float topRightRadius, float bottomRightRadius, float bottomLeftRadius, int color, float partial) {
    ...
    public static void renderSmoothImageRectRoundAllCornersScaled(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, float topLeftRadius, float topRightRadius, float bottomRightRadius, float bottomLeftRadius, int color, float partial) {
        float additionalScale = resolveAdditionalRenderScale();
        float translationX = resolveAdditionalRenderTranslationX();
        float translationY = resolveAdditionalRenderTranslationY();
    ...
    private static void renderSmoothImageRectInternal(@Nonnull GuiGraphics graphics, @Nonnull ResourceLocation texture, float x, float y, float width, float height, @Nonnull CornerRadii cornerRadii, @Nonnull TextureRegion textureRegion, int color, float partial) {
    ...
    private static void _renderSmoothImageRect(GuiGraphics graphics, float partial, RectArea area) {
        ...
        applyUniforms(postChain, area.textureRegion, scaledX, scaledY, scaledWidth, scaledHeight, scaledRadii, invRotation, red, green, blue, alpha, textureId);
    ...
    private static PostChain getOrCreatePostChain(Minecraft minecraft) {
        if (smoothImageRectPostChainFailed) {
            return null;
        }
        if (smoothImageRectPostChain == null) {
            try {
                smoothImageRectPostChain = new PostChain(
                        minecraft.getTextureManager(),
                        minecraft.getResourceManager(),
                        minecraft.getMainRenderTarget(),
                        GUI_SMOOTH_IMAGE_RECT_POST_CHAIN
                );
                cachedWidth = -1;
                cachedHeight = -1;
                ensurePostChainSize(smoothImageRectPostChain, minecraft.getWindow().getWidth(), minecraft.getWindow().getHeight());
            } catch (Exception ex) {
                smoothImageRectPostChainFailed = true;
                LOGGER.error("[FANCYMENU] Failed to load GUI smooth image rectangle shader!", ex);
                return null;
            }
        }
        return smoothImageRectPostChain;
    }
    ...
    private static void applyUniforms(PostChain postChain, TextureRegion textureRegion, float x, float y, float width, float height, CornerRadii cornerRadii, RenderRotationUtil.Rotation2D invRotation, float red, float green, float blue, float alpha, int textureId) {
        List<PostPass> passes = ((IMixinPostChain) postChain).getPasses_FancyMenu();
        for (PostPass pass : passes) {
            if (!"fancymenu_gui_smooth_image_rect".equals(pass.getName())) {
                continue;
            }
    ...
    private record RectArea(float x, float y, float width, float height, CornerRadii cornerRadii, TextureRegion textureRegion, ResourceLocation texture, int color) {
    }
