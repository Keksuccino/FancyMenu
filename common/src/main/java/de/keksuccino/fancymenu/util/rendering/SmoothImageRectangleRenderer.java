...
public final class SmoothImageRectangleRenderer {
    ...
    private static final ResourceLocation GUI_SMOOTH_IMAGE_RECT_POST_CHAIN = new ResourceLocation("minecraft", "shaders/post/fancymenu_gui_smooth_image_rect.json");
