...
public class LightHighContrastUITheme extends UITheme {
    ...
    public LightHighContrastUITheme() {
        ...
        super("light_high_contrast", "fancymenu.ui.themes.light_high_contrast");
        ...
        success_text_color = DrawableColor.of(new Color(0, 150, 0));
        error_text_color = DrawableColor.of(new Color(200, 0, 0));
        warning_text_color = DrawableColor.of(new Color(180, 110, 0));

        layout_editor_mouse_selection_rectangle_color = DrawableColor.of(new Color(0, 120, 255));
        layout_editor_grid_color_normal = DrawableColor.of(new Color(0, 0, 0, 140));
        layout_editor_grid_color_center = DrawableColor.of(new Color(0, 120, 255, 180));
        layout_editor_element_border_color_normal = DrawableColor.of(new Color(0, 0, 0));
        layout_editor_element_border_color_selected = DrawableColor.of(new Color(0, 120, 255));
        layout_editor_element_border_rotation_controls_color = DrawableColor.of(new Color(140, 0, 255));
        layout_editor_element_border_vertical_tilting_controls_color = DrawableColor.of(new Color(180, 110, 0));
        layout_editor_element_border_horizontal_tilting_controls_color = DrawableColor.of(new Color(0, 150, 0));
        layout_editor_element_dragging_not_allowed_color = DrawableColor.of(new Color(200, 0, 0, 220));
        ...
        actions_entry_background_color_action = DrawableColor.of(new Color(255, 255, 255));
        actions_entry_background_color_action_hover = DrawableColor.of(new Color(235, 235, 235));
        actions_entry_background_color_if = DrawableColor.of(new Color(230, 245, 255));
        actions_entry_background_color_if_hover = DrawableColor.of(new Color(210, 235, 255));
        actions_entry_background_color_else_if = DrawableColor.of(new Color(245, 230, 255));
        actions_entry_background_color_else_if_hover = DrawableColor.of(new Color(235, 210, 255));
        actions_entry_background_color_else = DrawableColor.of(new Color(255, 240, 220));
        actions_entry_background_color_else_hover = DrawableColor.of(new Color(255, 228, 200));
        actions_entry_background_color_while = DrawableColor.of(new Color(225, 245, 240));
        actions_entry_background_color_while_hover = DrawableColor.of(new Color(208, 236, 230));
        ...
        actions_entry_background_color_folder = DrawableColor.of(new Color(255, 230, 240));
        actions_entry_background_color_folder_hover = DrawableColor.of(new Color(248, 210, 226));
        actions_entry_background_color_generic_block = DrawableColor.of(new Color(240, 240, 240));
        actions_entry_background_color_generic_block_hover = DrawableColor.of(new Color(225, 225, 225));
        actions_chain_indicator_color = DrawableColor.of(new Color(0, 0, 0, 180));
        actions_chain_indicator_hovered_color = DrawableColor.of(new Color(0, 120, 255, 220));
        actions_chain_indicator_selected_color = DrawableColor.of(new Color(0, 120, 255, 240));
        actions_minimap_background_color = DrawableColor.of(new Color(255, 255, 255, 230));
        actions_minimap_border_color = DrawableColor.of(new Color(0, 0, 0, 230));
        actions_minimap_viewport_color = DrawableColor.of(new Color(0, 0, 0, 40));
        actions_minimap_viewport_border_color = DrawableColor.of(new Color(0, 120, 255, 140));
        actions_minimap_tooltip_border_color = DrawableColor.of(new Color(0, 120, 255, 220));
