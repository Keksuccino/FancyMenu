...
public abstract class AbstractFileBrowserScreen extends Screen {
    ...
    public void extractRenderState(@NotNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partial) {
        ...
        graphics.text(this.font, Component.translatable("fancymenu.ui.filechooser.files"), 20, 50, UIBase.getUIColorTheme().generic_text_base_color.getColorInt(), false);
    ...
    public boolean mouseClicked(MouseButtonEvent event, boolean isDoubleClick) {
        ...
        if ((event.button() == 0) && !this.fileListScrollArea.isMouseInsideArea() && !this.fileListScrollArea.isMouseInteractingWithGrabbers() && !this.previewTextScrollArea.isMouseInsideArea() && !this.previewTextScrollArea.isMouseInteractingWithGrabbers() && !this.isWidgetHovered()) {
            for (ScrollAreaEntry e : this.fileListScrollArea.getEntries()) {
                e.setSelected(false);
            }
            this.updatePreview(null);
    ...
    public abstract class AbstractFileScrollAreaEntry extends ScrollAreaEntry {
        ...
        public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partial) {
            ...
            if (this.file.exists()) {
                ...
                graphics.text(this.font, this.fileNameComponent, this.x + BORDER + 20 + 3, this.y + (this.height / 2) - (this.font.lineHeight / 2) , textColor, false);
    ...
    public class ParentDirScrollAreaEntry extends ScrollAreaEntry {
        ...
        public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partial) {
            ...
            //Render file name
            graphics.text(this.font, this.labelComponent, this.x + BORDER + 20 + 3, this.y + (this.height / 2) - (this.font.lineHeight / 2) , -1, false);
