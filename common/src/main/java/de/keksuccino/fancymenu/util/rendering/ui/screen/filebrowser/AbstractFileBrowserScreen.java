...
public abstract class AbstractFileBrowserScreen extends ModernScreen {
    ...
    protected static final ResourceLocation GO_UP_ICON_TEXTURE = new ResourceLocation("fancymenu", "textures/file_browser/go_up_icon.png");
    protected static final ResourceLocation FILE_ICON_TEXTURE = new ResourceLocation("fancymenu", "textures/file_browser/file_icon.png");
    protected static final ResourceLocation FOLDER_ICON_TEXTURE = new ResourceLocation("fancymenu", "textures/file_browser/folder_icon.png");
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        graphics.drawString(this.font, Component.translatable("fancymenu.ui.filechooser.files"), 20, 50, UIBase.getUITheme().ui_interface_generic_text_color.getColorInt(), false);
    ...
    protected void renderFileTypeScrollArea(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        graphics.drawString(this.font, FILE_TYPE_PREFIX_TEXT, this.fileTypeScrollArea.getXWithBorder() - Minecraft.getInstance().font.width(FILE_TYPE_PREFIX_TEXT) - 5, this.fileTypeScrollArea.getYWithBorder() + (this.fileTypeScrollArea.getHeightWithBorder() / 2) - (Minecraft.getInstance().font.lineHeight / 2), UIBase.getUITheme().ui_interface_widget_label_color_normal.getColorInt(), false);
    }
    ...
    protected void renderPreview(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        if (this.previewTextureSupplier != null) {
            ...
            if (loc != null) {
                ...
                UIBase.resetShaderColor(graphics);
                UIBase.renderBorder(graphics, x, y, x + w, y + h, UIBase.ELEMENT_BORDER_THICKNESS, UIBase.getUITheme().ui_interface_area_border_color.getColor(), true, true, true, true);
            }
        } else {
    ...
    protected int renderCurrentDirectoryField(GuiGraphics graphics, int mouseX, int mouseY, float partial, int x, int y, int width, int height) {
        ...
        UIBase.renderBorder(graphics, x, y, xEnd, yEnd, 1, UIBase.getUITheme().ui_interface_area_border_color.getColor(), true, true, true, true);
    ...
    protected void updateCurrentDirectoryComponent() {
        try {
            ...
            this.currentDirectoryComponent.setBaseColorSupplier(consumes -> UIBase.getUITheme().ui_interface_generic_text_color);
                ...
                if (text == null) {
                    ...
                    if (lines != null) {
                        ...
                        for (String s : lines) {
                            line++;
                            if (line < 70) {
                                TextScrollAreaEntry e = new TextScrollAreaEntry(this.previewTextScrollArea, Component.literal(s).withStyle(Style.EMPTY.withColor(UIBase.getUITheme().ui_interface_generic_text_color.getColorInt())), (entry) -> {});
                                e.setSelectable(false);
                                e.setBackgroundColorHover(e.getBackgroundColorIdle());
                                e.setPlayClickSound(false);
                                this.previewTextScrollArea.addEntry(e);
                            } else {
                                TextScrollAreaEntry e = new TextScrollAreaEntry(this.previewTextScrollArea, Component.literal("......").withStyle(Style.EMPTY.withColor(UIBase.getUITheme().ui_interface_generic_text_color.getColorInt())), (entry) -> {});
                                e.setSelectable(false);
                                e.setBackgroundColorHover(e.getBackgroundColorIdle());
                                e.setPlayClickSound(false);
                                this.previewTextScrollArea.addEntry(e);
                                TextScrollAreaEntry e2 = new TextScrollAreaEntry(this.previewTextScrollArea, Component.literal("  ").withStyle(Style.EMPTY.withColor(UIBase.getUITheme().ui_interface_generic_text_color.getColorInt())), (entry) -> {});
    ...
    protected void setNoTextPreview() {
        if (this.previewTextScrollArea == null) return;
        this.previewTextScrollArea.clearEntries();
        TextScrollAreaEntry e = new TextScrollAreaEntry(this.previewTextScrollArea, Component.translatable("fancymenu.ui.filechooser.no_preview").withStyle(Style.EMPTY.withColor(UIBase.getUITheme().ui_interface_generic_text_color.getColorInt())), (entry) -> {});
        e.setSelectable(false);
        e.setBackgroundColorHover(e.getBackgroundColorIdle());
        e.setPlayClickSound(false);
        this.previewTextScrollArea.addEntry(e);
    ...
    public abstract class AbstractFileScrollAreaEntry extends ScrollAreaEntry {
        ...
        public void render(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
            ...
            if (this.file.exists()) {
                ...
                //Render file name
                int textColor = this.resourceUnfriendlyFileName ? UIBase.getUITheme().error_color.getColorInt() : UIBase.getUITheme().ui_interface_generic_text_color.getColorInt();
                ...
                if (this.isHovered() && this.parent.isMouseInsideArea() && this.resourceUnfriendlyFileName) {
                    TooltipHandler.INSTANCE.addRenderTickTooltip(UITooltip.of(LocalizationUtils.splitLocalizedLines("fancymenu.ui.filechooser.resource_name_check.not_passed.tooltip")), () -> true);
                }
    ...
    public class ParentDirScrollAreaEntry extends ScrollAreaEntry {
        ...
        public ParentDirScrollAreaEntry(@NotNull ScrollArea parent) {
            ...
            super(parent, 100, 30);
            this.labelComponent = Component.translatable("fancymenu.ui.filechooser.go_up").setStyle(Style.EMPTY.withColor(UIBase.getUITheme().ui_interface_widget_label_color_normal.getColorInt()).withBold(true));
