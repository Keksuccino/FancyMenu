...
public class MixinWorldListEntry {
    ...
    private boolean wrapBlitInRenderFancyMenu(PoseStack poseStack, int p_93135_, int p_93136_, float p_93137_, float p_93138_, int p_93139_, int p_93140_, int p_93141_, int i) {
        if (i == 32) {
    ...
    private boolean wrapFillInRenderFancyMenu(PoseStack poseStack, int p_93174_, int p_93175_, int p_93176_, int p_93177_, int p_93178_) {
        return FancyMenu.getOptions().showSingleplayerScreenWorldIcons.getValue();
    }
