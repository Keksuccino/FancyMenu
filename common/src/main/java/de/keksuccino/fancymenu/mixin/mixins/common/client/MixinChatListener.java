...
public class MixinChatListener {
    ...
    private void wrap_addMessage_handleSystemMessage_FancyMenu(
        ...
        if (Listeners.ON_SYSTEM_MESSAGE_RECEIVED_IN_CHAT.hasInstancesListening()) Listeners.ON_SYSTEM_MESSAGE_RECEIVED_IN_CHAT.onSystemMessageReceivedInChat(component);
    }
}
