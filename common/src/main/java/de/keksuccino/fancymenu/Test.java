...
public class Test {
    ...
    public void onInitScreenPost(InitOrResizeScreenCompletedEvent e) {
        ...
        e.addRenderableWidget(new ExtendedButton(20, 20, 100, 20, "Open PiP Window", button -> {
            ...
            PiPWindowHandler.INSTANCE.openWindow(new PiPWindow(Component.translatable("fancymenu.ui.color_picker.title"), 100, 100, 500, 500, s));
        }));
        ...
        e.addRenderableWidget(new ExtendedButton(20, 45, 100, 20, "Open PiP Window 2", button -> {
            ...
            PiPWindowHandler.INSTANCE.openWindow(new PiPWindow(Component.literal("Some Window"), 100, 100, 500, 500, s));
        }));
