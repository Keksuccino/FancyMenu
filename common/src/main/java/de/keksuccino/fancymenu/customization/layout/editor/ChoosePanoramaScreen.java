...
public class ChoosePanoramaScreen extends Screen {
    ...
    public void render(@NotNull PoseStack pose, int mouseX, int mouseY, float partial) {
        ...
        GuiComponent.drawString(pose, this.font, Component.translatable("fancymenu.panorama.choose.available_panoramas"), 20, 50, UIBase.getUIColorTheme().generic_text_base_color.getColorInt());
