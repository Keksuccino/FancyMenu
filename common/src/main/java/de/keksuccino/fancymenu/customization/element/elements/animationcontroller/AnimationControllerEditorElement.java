...
public class AnimationControllerEditorElement extends AbstractEditorElement {
    ...
    public void init() {
        ...
        this.rightClickMenu.addClickableEntry("manage_keyframes", Components.translatable("fancymenu.elements.animation_controller.manage_keyframes"),
                        (menu, entry) -> {
        ...
        this.rightClickMenu.addClickableEntry("manage_targets", Components.translatable("fancymenu.elements.animation_controller.manage_targets"),
                        (menu, entry) -> {
