...
public class SetAudioElementVolumeAction extends Action {
    ...
    public @NotNull Component getActionDisplayName() {
        return Components.translatable("fancymenu.actions.audio.set_audio_element_volume");
    }
    ...
    public Component getValueDisplayName() {
        return Components.translatable("fancymenu.actions.audio.set_audio_element_volume.value.desc");
    }
