...
public class TextEditorElement extends AbstractEditorElement {
    ...
    public void init() {
        ...
        this.addStringInputContextMenuEntryTo(this.rightClickMenu, "set_text_content",
                        ...
                        null, true, true, Components.translatable("fancymenu.elements.text.v2.source.input"),
        ...
        this.addGenericStringInputContextMenuEntryTo(this.rightClickMenu, "set_base_color",
                        ...
                        (element, colorHex) -> ((TextElement)element.element).markdownRenderer.setTextBaseColor(DrawableColor.of(colorHex)), null, false, false, Components.translatable("fancymenu.customization.items.text.base_color"),
        ...
        this.rightClickMenu.addSubMenuEntry("markdown", Components.translatable("fancymenu.customization.items.text.markdown"), markdownMenu).setStackable(true);
        ...
        this.addStringInputContextMenuEntryTo(markdownMenu, "code_block_single_line_color", TextEditorElement.class,
                        ...
                        null, false, false, Components.translatable("fancymenu.customization.items.text.markdown.code_block.single.color"),
        ...
        this.addStringInputContextMenuEntryTo(markdownMenu, "code_block_multi_line_color", TextEditorElement.class,
                        ...
                        null, false, false, Components.translatable("fancymenu.customization.items.text.markdown.code_block.multi.color"),
        ...
        this.addStringInputContextMenuEntryTo(markdownMenu, "headline_line_color", TextEditorElement.class,
                        ...
                        null, false, false, Components.translatable("fancymenu.customization.items.text.markdown.headline.line.color"),
        ...
        this.addStringInputContextMenuEntryTo(markdownMenu, "separation_line_color", TextEditorElement.class,
                        ...
                        null, false, false, Components.translatable("fancymenu.customization.items.text.markdown.separation_line.color"),
                        true, DrawableColor.of(169, 169, 169).getHex(), TextValidators.HEX_COLOR_TEXT_VALIDATOR, null)
                .setStackable(true);
        ...
        this.addStringInputContextMenuEntryTo(markdownMenu, "hyperlink_color", TextEditorElement.class,
                        ...
                        null, false, false, Components.translatable("fancymenu.customization.items.text.markdown.hyperlink.color"),
        ...
        this.addStringInputContextMenuEntryTo(markdownMenu, "quote_color", TextEditorElement.class,
                        ...
                        null, false, false, Components.translatable("fancymenu.customization.items.text.markdown.quote.color"),
        ...
        this.addIntegerInputContextMenuEntryTo(markdownMenu, "quote_indent", TextEditorElement.class,
                        ...
                        Components.translatable("fancymenu.customization.items.text.markdown.quote.indent"), true, 8, null, null)
                .setStackable(true);
        ...
        this.addStringInputContextMenuEntryTo(markdownMenu, "bullet_list_dot_color", TextEditorElement.class,
                        ...
                        null, false, false, Components.translatable("fancymenu.customization.items.text.markdown.bullet_list.dot.color"),
                        true, DrawableColor.of(169, 169, 169).getHex(), TextValidators.HEX_COLOR_TEXT_VALIDATOR, null)
                .setStackable(true);
        ...
        this.addIntegerInputContextMenuEntryTo(markdownMenu, "bullet_list_indent", TextEditorElement.class,
                        ...
                        Components.translatable("fancymenu.customization.items.text.markdown.bullet_list.indent"), true, 8, null, null)
                .setStackable(true);
        ...
        this.addImageResourceChooserContextMenuEntryTo(grabberTextureMenu, "vertical_normal_grabber_texture",
                ...
                Components.translatable("fancymenu.customization.items.text.vertical_scroll_grabber_texture.normal"),
        ...
        this.addImageResourceChooserContextMenuEntryTo(grabberTextureMenu, "vertical_hover_grabber_texture",
                ...
                Components.translatable("fancymenu.customization.items.text.vertical_scroll_grabber_texture.hover"),
                true, null, true, true, true);
        ...
        this.addImageResourceChooserContextMenuEntryTo(grabberTextureMenu, "horizontal_normal_grabber_texture",
                ...
                Components.translatable("fancymenu.customization.items.text.horizontal_scroll_grabber_texture.normal"),
                true, null, true, true, true);
        ...
        this.addImageResourceChooserContextMenuEntryTo(grabberTextureMenu, "horizontal_hover_grabber_texture",
                ...
                Components.translatable("fancymenu.customization.items.text.horizontal_scroll_grabber_texture.hover"),
                true, null, true, true, true);
