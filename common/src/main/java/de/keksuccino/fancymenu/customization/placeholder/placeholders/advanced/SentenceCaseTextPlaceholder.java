...
public class SentenceCaseTextPlaceholder extends Placeholder {
    ...
    public String getReplacementFor(DeserializedPlaceholderString dps) {
        try {
            ...
            LOGGER.error("[FANCYMENU] Failed to parse 'Sentence Case Text' placeholder!", ex);
        }
        return null;
    }
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("fancymenu.placeholders.sentence_case_text");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines("fancymenu.placeholders.sentence_case_text.desc"));
    }
    ...
    public @NotNull DeserializedPlaceholderString getDefaultPlaceholderString() {
        ...
        m.put("text", "hello world. this is fancymenu!");
