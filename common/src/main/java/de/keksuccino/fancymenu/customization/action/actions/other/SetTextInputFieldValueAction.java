...
public class SetTextInputFieldValueAction extends Action {
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("fancymenu.actions.set_text_input_field_value.desc");
    }
    ...
    public static class SetTextInputFieldValueActionValueScreen extends PiPCellWindowBody {
