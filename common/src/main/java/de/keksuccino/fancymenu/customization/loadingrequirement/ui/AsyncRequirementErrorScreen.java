...
public class AsyncRequirementErrorScreen extends QueueableNotificationScreen {
    ...
    public AsyncRequirementErrorScreen(@NotNull Component requirementName) {
        ...
        Component requirementNameFormatted = requirementName.copy().withStyle(Style.EMPTY.withBold(true).withColor(UIBase.getUIColorTheme().error_text_color.getColorInt()));
