...
public class HasPlayerAbsorptionHeartsRequirement extends Requirement {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.requirements.world.has_player_absorption_hearts");
    }

    @Override
    public Component getDescription() {
        return Component.translatable("fancymenu.requirements.world.has_player_absorption_hearts.desc");
    }
