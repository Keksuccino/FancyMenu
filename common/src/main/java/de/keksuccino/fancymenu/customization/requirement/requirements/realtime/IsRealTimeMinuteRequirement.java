...
public class IsRealTimeMinuteRequirement extends Requirement {
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("fancymenu.requirements.realtime_minute");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines("fancymenu.requirements.realtime_minute.desc"));
    }
    ...
    public String getValueDisplayName() {
        return I18n.get("fancymenu.requirements.realtime_minute.value_name");
    }
