...
public class IsRealTimeYearRequirement extends Requirement {
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("fancymenu.requirements.realtime_year");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines("fancymenu.requirements.realtime_year.desc"));
    }
    ...
    public String getValueDisplayName() {
        return I18n.get("fancymenu.requirements.realtime_year.value_name");
    }
