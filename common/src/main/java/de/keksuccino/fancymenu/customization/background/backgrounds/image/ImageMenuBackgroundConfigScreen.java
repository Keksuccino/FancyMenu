...
public class ImageMenuBackgroundConfigScreen extends CellScreen {
    ...
    protected void initCells() {
        ...
        this.addWidgetCell(new ExtendedButton(0, 0, 0, 20, Components.translatable("fancymenu.background.image.configure.parallax_intensity"), var1 -> {
            ...
            TextInputScreen s = TextInputScreen.build(Components.translatable("fancymenu.background.image.configure.parallax_intensity"), CharacterFilter.buildDecimalFiler(), callback -> {
                if (callback != null) {
