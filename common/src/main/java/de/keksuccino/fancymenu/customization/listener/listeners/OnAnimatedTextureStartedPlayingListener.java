...
public class OnAnimatedTextureStartedPlayingListener extends AbstractListener {
    ...
    public OnAnimatedTextureStartedPlayingListener() {
        super("animated_texture_started_playing");
    }
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.listeners.on_animated_texture_started_playing");
    }

    @Override
    public @NotNull List<Component> getDescription() {
        return List.of(LocalizationUtils.splitLocalizedLines("fancymenu.listeners.on_animated_texture_started_playing.desc"));
    }
}
