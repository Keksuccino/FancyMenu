...
public class ChooseSlideshowScreen extends Screen {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        graphics.drawString(this.font, Component.translatable("fancymenu.slideshow.choose.available_slideshows"), 20, 50, UIBase.getUITheme().ui_interface_generic_text_color.getColorInt(), false);
        ...
        if (this.selectedSlideshow != null) {
            ...
            int slideY = 50 + 15;
            graphics.fill(slideX, slideY, slideX + slideW, slideY + slideH, UIBase.getUITheme().ui_interface_area_background_color_type_1.getColorInt());
    ...
    public static class SlideshowScrollEntry extends TextListScrollAreaEntry {
        ...
        public SlideshowScrollEntry(ScrollArea parent, @NotNull String slideshow, @NotNull Consumer<TextListScrollAreaEntry> onClick) {
            super(parent, Component.literal(slideshow).setStyle(Style.EMPTY.withColor(UIBase.getUITheme().ui_interface_widget_label_color_normal.getColorInt())), UIBase.getUITheme().bullet_list_dot_color_1, onClick);
