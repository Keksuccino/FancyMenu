...
public class ChooseAnimationScreen extends Screen {
    ...
    public void render(@NotNull PoseStack pose, int mouseX, int mouseY, float partial) {
        ...
        this.font.draw(pose, Components.translatable("fancymenu.animation.choose.available_animations"), 20, 50, UIBase.getUIColorTheme().generic_text_base_color.getColorInt());
        ...
        Component previewLabel = Components.translatable("fancymenu.animation.choose.preview");
        ...
        if (this.selectedAnimation != null) {
            ...
            fill(pose, aniX, aniY, aniX + aniW, aniY + aniH, UIBase.getUIColorTheme().area_background_color.getColorInt());
            ...
            UIBase.renderBorder(pose, aniX, aniY, aniX + aniW, aniY + aniH, UIBase.ELEMENT_BORDER_THICKNESS, UIBase.getUIColorTheme().element_border_color_normal.getColor(), true, true, true, true);
        }
    ...
    protected void updateAnimationScrollAreaContent() {
        ...
        if (this.animationListScrollArea.getEntries().isEmpty()) {
            this.animationListScrollArea.addEntry(new TextScrollAreaEntry(this.animationListScrollArea, Components.translatable("fancymenu.animation.choose.no_animations"), (entry) -> {}));
        }
