...
public class IsCameraPerspectiveRequirement extends Requirement {
    ...
    public void editValue(@NotNull RequirementInstance instance, @NotNull RequirementEditingCompletedFeedback onEditingCompleted, @NotNull RequirementEditingCanceledFeedback onEditingCanceled) {
        ...
        IsCameraPerspectiveValueConfigScreen s = new IsCameraPerspectiveValueConfigScreen(Objects.requireNonNullElse(instance.value, this.getValuePreset()), callback -> {
            if (handled[0]) {
                return;
            }
            handled[0] = true;
