...
public class ImageMenuBackground extends MenuBackground<ImageMenuBackground> {
    ...
    protected void renderRepeatBackground(@NotNull GuiGraphicsExtractor graphics, @NotNull Identifier resourceLocation, ITexture tex, float[] parallaxOffset, float parallaxIntensityX, float parallaxIntensityY) {
    ...
    protected void renderSlideBackground(@NotNull GuiGraphicsExtractor graphics, @NotNull AspectRatio ratio, @NotNull Identifier resourceLocation, float[] parallaxOffset, float parallaxIntensityX, float parallaxIntensityY) {
    ...
    protected void renderKeepAspectRatio(@NotNull GuiGraphicsExtractor graphics, @NotNull AspectRatio ratio, @NotNull Identifier resourceLocation, float[] parallaxOffset, float parallaxIntensityX, float parallaxIntensityY) {
