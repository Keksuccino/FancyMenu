...
public class ImageMenuBackground extends MenuBackground {
    ...
    protected void renderRepeatBackground(@NotNull GuiGraphicsExtractor graphics, @NotNull Identifier resourceLocation, ITexture tex, float[] parallaxOffset) {
        if (parallaxEnabled) {
    ...
    protected void renderSlideBackground(@NotNull GuiGraphicsExtractor graphics, @NotNull AspectRatio ratio, @NotNull Identifier resourceLocation, float[] parallaxOffset) {
    ...
    protected void renderKeepAspectRatio(@NotNull GuiGraphicsExtractor graphics, @NotNull AspectRatio ratio, @NotNull Identifier resourceLocation, float[] parallaxOffset) {
    ...
    protected void renderFullScreen(@NotNull GuiGraphicsExtractor graphics, @NotNull Identifier resourceLocation, float[] parallaxOffset) {
        if (parallaxEnabled) {
