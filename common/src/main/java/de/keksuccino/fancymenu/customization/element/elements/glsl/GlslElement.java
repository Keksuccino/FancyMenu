...
public class GlslElement extends AbstractElement {
    ...
    private void renderErrorOverlay(@NotNull GuiGraphicsExtractor graphics, int x, int y, int width, int height, @NotNull String message) {
        ...
        for (String line : lines) {
            graphics.text(font, line, boxX + 2, lineY, 0xFFFF6666, false);
            lineY += lineHeight;
        }
    }
