...
public class ToggleElementAnimatorAction extends Action {
    ...
    public void execute(@Nullable String value) {
        try {
            ...
            LOGGER.error("[FANCYMENU] Failed to execute ToggleElementAnimatorAction!", ex);
        }
    }
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("fancymenu.actions.toggle_element_animator.desc");
    }
