...
public class IsPlayerRidingEntityWithHealthRequirement extends Requirement {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.requirements.world.is_player_riding_entity_with_health");
    }

    @Override
    public Component getDescription() {
        return Component.translatable("fancymenu.requirements.world.is_player_riding_entity_with_health.desc");
    }
