...
//
//public class AnchorPointOverlayOLD extends GuiComponent implements Renderable, GuiEventListener {
//
...
//
//    public AnchorPointOverlayOLD(@NotNull LayoutEditorScreen editor) {
//        this.editor = editor;
//    }
//
//    @Override
...
//            return AnchorPointOverlayOLD.this.editor.getElementByInstanceIdentifier(this.elementIdentifier);
//        }
//
//        @Override
//        protected int getX() {
...
//            if (AnchorPointOverlayOLD.this.leftMouseDown && AnchorPointOverlayOLD.this.isElementPressed()) {
