...
public class OnCloseScreenListener extends AbstractListener {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.listeners.on_close_screen");
    }

    @Override
    public @NotNull List<Component> getDescription() {
        return List.of(LocalizationUtils.splitLocalizedLines("fancymenu.listeners.on_close_screen.desc"));
    }
}