...
public class OnVideoFinishedPlayingListener extends AbstractListener {
    ...
    public OnVideoFinishedPlayingListener() {
        super("video_finished_playing");
    }

    public void onVideoFinishedPlaying(@Nullable String videoSource, @Nullable String videoSourceType, boolean willRestart) {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.listeners.on_video_finished_playing");
    }

    @Override
    public @NotNull List<Component> getDescription() {
        return List.of(LocalizationUtils.splitLocalizedLines("fancymenu.listeners.on_video_finished_playing.desc"));
    }
}
