...
public class OnServerLeftListener extends AbstractListener {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.listeners.on_server_left");
    }

    @Override
    public @NotNull List<Component> getDescription() {
        return List.of(LocalizationUtils.splitLocalizedLines("fancymenu.listeners.on_server_left.desc"));
    }
}