...
public final class SeamlessWorldLoadingHandler {
    ...
    private static RenderableResource getActiveLoadingBackground(@Nullable Screen screen) {
        ...
        if (screen instanceof GenericDirtMessageScreen genericMessageScreen) {
    ...
    @Nullable
    private static ITexture getWorldJoinGenericMessageTexture(@NotNull GenericDirtMessageScreen screen) {
        if (!isWorldJoinGenericDirtMessageScreen(screen) || LastWorldHandler.isLastWorldServer()) {
            return null;
        }
    ...
    private static boolean isWorldJoinGenericDirtMessageScreen(@NotNull GenericDirtMessageScreen screen) {
    ...
    private static boolean isLoadingScreen(@Nullable Screen screen) {
        ...
        if (screen instanceof GenericDirtMessageScreen genericMessageScreen) {
            return activeTarget != null || isWorldJoinGenericDirtMessageScreen(genericMessageScreen);
        }
