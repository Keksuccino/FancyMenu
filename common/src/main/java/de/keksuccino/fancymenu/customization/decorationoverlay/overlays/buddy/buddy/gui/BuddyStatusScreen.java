...
public class BuddyStatusScreen implements Renderable {
    ...
    // GUI Texture
    public static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("fancymenu", "textures/buddy/gui/status_screen_background.png");
    public static final ResourceLocation BACKGROUND_BORDER_TEXTURE = new ResourceLocation("fancymenu", "textures/buddy/gui/status_screen_background_border.png");
    public static final ResourceLocation TAB_BUTTON_TEXTURE_NORMAL = new ResourceLocation("fancymenu", "textures/buddy/gui/tab_button_normal.png");
    public static final ResourceLocation TAB_BUTTON_TEXTURE_SELECTED = new ResourceLocation("fancymenu", "textures/buddy/gui/tab_button_selected.png");
    public static final ResourceLocation STATUS_BAR_TEXTURE = new ResourceLocation("fancymenu", "textures/buddy/gui/status_bar_fill.png");
    public static final ResourceLocation STATUS_BAR_BACKGROUND_TEXTURE = new ResourceLocation("fancymenu", "textures/buddy/gui/status_bar_background.png");
    public static final ResourceLocation STATUS_ICON_HUNGER = new ResourceLocation("fancymenu", "textures/buddy/gui/icon_hunger.png");
    public static final ResourceLocation STATUS_ICON_HAPPINESS = new ResourceLocation("fancymenu", "textures/buddy/gui/icon_happiness.png");
    public static final ResourceLocation STATUS_ICON_ENERGY = new ResourceLocation("fancymenu", "textures/buddy/gui/icon_energy.png");
    public static final ResourceLocation STATUS_ICON_FUN = new ResourceLocation("fancymenu", "textures/buddy/gui/icon_fun.png");
    public static final ResourceLocation STATUS_ICON_EXPERIENCE = new ResourceLocation("fancymenu", "textures/buddy/gui/icon_experience.png");
