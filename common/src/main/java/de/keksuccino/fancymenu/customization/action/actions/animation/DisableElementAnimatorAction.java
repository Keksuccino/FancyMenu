...
public class DisableElementAnimatorAction extends Action {
    ...
    public void execute(@Nullable String value) {
        try {
            ...
            LOGGER.error("[FANCYMENU] Failed to execute DisableElementAnimatorAction!", ex);
        }
    }
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("fancymenu.actions.disable_element_animator.desc");
    }
