...
public final class LastDeathMessageTracker {
    ...
    public static void record(@Nullable Component deathMessage) {
        record(deathMessage, LastDeathMessageTracker::serialize);
    }

    static synchronized void record(@Nullable Component deathMessage, @NotNull Function<Component, String> serializer) {
        ...
        cachedJson = serializer.apply(deathMessage);
    }
