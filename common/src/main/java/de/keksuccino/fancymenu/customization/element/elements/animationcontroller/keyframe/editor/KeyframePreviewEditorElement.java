...
final class KeyframePreviewEditorElement extends AbstractEditorElement<KeyframePreviewEditorElement, KeyframePreviewElement> {
    ...
    public void renderPreviewBody(@NotNull GuiGraphics graphics) {
        ...
        graphics.fill(RenderType.gui(), this.element.getAbsoluteX(), this.element.getAbsoluteY(), this.element.getAbsoluteX() + this.element.getAbsoluteWidth(), this.element.getAbsoluteY() + this.element.getAbsoluteHeight(), color.getColorInt());
    }
