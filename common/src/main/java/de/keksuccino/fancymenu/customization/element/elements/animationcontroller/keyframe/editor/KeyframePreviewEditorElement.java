...
final class KeyframePreviewEditorElement extends AbstractEditorElement<KeyframePreviewEditorElement, KeyframePreviewElement> {
    ...
    public void renderPreviewBody(@NotNull GuiGraphicsExtractor graphics) {
        ...
        graphics.fill(this.element.getAbsoluteX(), this.element.getAbsoluteY(), this.element.getAbsoluteX() + this.element.getAbsoluteWidth(), this.element.getAbsoluteY() + this.element.getAbsoluteHeight(), color.getColorInt());
    }
