...
public class NativeVideoElement extends AbstractElement implements IVideoElement {
    ...
    protected void renderWatermediaMissingOverlay_FancyMenu(@NotNull GuiGraphicsExtractor graphics, double mouseX, double mouseY, int x, int y, int w, int h) {
    ...
    protected void renderFullArea(@NotNull GuiGraphicsExtractor graphics, @NotNull Identifier resourceLocation) {
