...
public class KeyframeManagerScreen extends ModernScreen {
    ...
    protected static final Component KEYFRAME_ADDED_TEXT = Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.keyframe_added").setStyle(Style.EMPTY.withColor(UIBase.getUIColorTheme().success_text_color.getColorInt()));
    protected static final Component KEYFRAME_DELETED_TEXT = Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.keyframe_deleted").setStyle(Style.EMPTY.withColor(UIBase.getUIColorTheme().warning_text_color.getColorInt()));
    protected static final Component PLAYING_STARTED_TEXT = Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.playing_started").setStyle(Style.EMPTY.withColor(UIBase.getUIColorTheme().success_text_color.getColorInt()));
    protected static final Component PLAYING_STOPPED_TEXT = Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.playing_stopped").setStyle(Style.EMPTY.withColor(UIBase.getUIColorTheme().warning_text_color.getColorInt()));
    ...
    public KeyframeManagerScreen(AnimationControllerElement controller, Consumer<AnimationControllerMetadata> resultCallback) {
        super(Components.translatable("fancymenu.elements.animation_controller.keyframe_manager"));
    ...
    protected void init() {
        ...
        ExtendedButton cancelButton = UIBase.applyDefaultWidgetSkinTo(new ExtendedButton(10, 10, buttonBaseWidth, 20,
                Components.translatable("gui.cancel"),
        ...
        ExtendedButton doneButton = UIBase.applyDefaultWidgetSkinTo(new ExtendedButton(80, 10, buttonBaseWidth, 20,
                Components.translatable("gui.done"),
        ...
        this.playButton.setLabelSupplier(consumes -> Components.translatable(isPlaying ? "fancymenu.elements.animation_controller.keyframe_manager.pause" : "fancymenu.elements.animation_controller.keyframe_manager.play"));
        ...
        this.startStopRecordingButton.setLabelSupplier(consumes ->
                Components.translatable(isRecording ?
        ...
        this.recordingSpeedSlider = new RangeSlider(0, 0, buttonBaseWidth + 60, 20, Components.empty(), 0, 100, this.recordingSpeed * 100);
        ...
        recordingSpeedSlider.setLabelSupplier(slider -> {
            ...
            return Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.recording_speed", speedText);
        });
        ...
        ExtendedButton addKeyframeButton = UIBase.applyDefaultWidgetSkinTo(new ExtendedButton(0, 0, buttonBaseWidth, 0,
                Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.add_keyframe"),
        ...
        this.deleteKeyframeButton = UIBase.applyDefaultWidgetSkinTo(new ExtendedButton(0, 0, buttonBaseWidth, 0,
                Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.delete_keyframe"),
        ...
        this.smoothingButton = UIBase.applyDefaultWidgetSkinTo(new ExtendedButton(0, 0, buttonBaseWidth, 0,
                Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.smoothing"),
        ...
        this.undoButton = UIBase.applyDefaultWidgetSkinTo(new ExtendedButton(0, 0, buttonBaseWidth, 0,
                Components.translatable("fancymenu.editor.edit.undo"),
                button -> undo()));
        ...
        this.redoButton = UIBase.applyDefaultWidgetSkinTo(new ExtendedButton(0, 0, buttonBaseWidth, 0,
                Components.translatable("fancymenu.editor.edit.redo"),
                button -> redo()));
        ...
        // Smoothing input box
        this.smoothingDistanceInput = new ExtendedEditBox(Minecraft.getInstance().font, (this.width / 2) - 50, this.stickyButton.y - 40, 100, 20, Components.empty()) {
            @Override
            public void render(@NotNull PoseStack pose, int mouseX, int mouseY, float partial) {
                GuiGraphics graphics = GuiGraphics.currentGraphics();
                MutableComponent c = Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.smoothing.input");
    ...
    protected void renderTimeText(@NotNull GuiGraphics graphics, long actualEndTime) {
        ...
        MutableComponent currentTimeComp = Components.literal(currentTimeStr).setStyle(Style.EMPTY.withColor(currentTimeColor));
        MutableComponent totalTimeComp = Components.literal(totalTimeStr);
        MutableComponent baseComp = Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.time", currentTimeComp, totalTimeComp);
    ...
    protected void renderRecordingIndicator(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        if (isRecording) {
            ...
            MutableComponent recordingText = Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.recording").setStyle(Style.EMPTY.withColor(RECORDING_COLOR.getColorInt()));
            MutableComponent manualModeText = Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.recording_speed.manual_mode").setStyle(Style.EMPTY.withColor(RECORDING_PAUSED_COLOR.getColorInt()));
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (isOverProgressLine((int)mouseX, (int)mouseY) && this.isRecording && !this.isRecordingPaused) {
            this.displayNotification(Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.pause_recording_to_drag_progress")
        ...
        if (this.isRecording && !this.isRecordingPaused && (clickedIndex >= 0)) {
            this.displayNotification(Components.translatable("fancymenu.elements.animation_controller.keyframe_manager.pause_recording_to_edit_keyframe")
                    .setStyle(Style.EMPTY.withColor(UIBase.getUIColorTheme().warning_text_color.getColorInt())), 6000);
            return true;
        }
        if (clickedIndex >= 0) {
    ...
    protected void setStickyAnchor(boolean sticky) {
        if (this.selectedKeyframes.size() == 1) {
            saveState();
            this.selectedKeyframes.get(0).stickyAnchor = sticky;
        }
