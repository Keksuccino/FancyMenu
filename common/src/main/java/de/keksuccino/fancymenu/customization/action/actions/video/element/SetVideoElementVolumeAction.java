...
public class SetVideoElementVolumeAction extends Action {
    ...
    public void execute(@Nullable String value) {
        ...
        try {
            ...
            LOGGER.error("[FANCYMENU] Failed to execute SetVideoElementVolumeAction!", ex);
        }
    ...
    public @NotNull Component getActionDisplayName() {
        return Component.translatable("fancymenu.actions.video.set_video_element_volume");
    }

    @Override
    public @NotNull Component[] getActionDescription() {
        return LocalizationUtils.splitLocalizedLines("fancymenu.actions.video.set_video_element_volume.desc");
    }

    @Override
    public Component getValueDisplayName() {
        return Component.translatable("fancymenu.actions.video.set_video_element_volume.value.desc");
    }
