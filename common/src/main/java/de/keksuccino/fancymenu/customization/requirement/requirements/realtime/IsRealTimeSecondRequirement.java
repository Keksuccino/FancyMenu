...
public class IsRealTimeSecondRequirement extends Requirement {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.requirements.realtime_second");
    }

    @Override
    public Component getDescription() {
        return Component.translatable("fancymenu.requirements.realtime_second.desc");
    }
    ...
    public Component getValueDisplayName() {
        return Component.translatable("fancymenu.requirements.realtime_second.value_name");
    }
