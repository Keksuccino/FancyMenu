...
public class ManageLayoutsScreen extends Screen {
    ...
    public void extractRenderState(@NotNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partial) {
        ...
        graphics.text(this.font, Component.translatable("fancymenu.layout.manage.layouts"), 20, 50, UIBase.getUIColorTheme().generic_text_base_color.getColorInt(), false);
        ...
        this.layoutListScrollArea.extractRenderState(graphics, mouseX, mouseY, partial);
        ...
        this.sortingButton.extractRenderState(graphics, mouseX, mouseY, partial);
        ...
        this.openInTextEditorButton.extractRenderState(graphics, mouseX, mouseY, partial);
        ...
        this.deleteButton.extractRenderState(graphics, mouseX, mouseY, partial);
        ...
        this.toggleStatusButton.extractRenderState(graphics, mouseX, mouseY, partial);
