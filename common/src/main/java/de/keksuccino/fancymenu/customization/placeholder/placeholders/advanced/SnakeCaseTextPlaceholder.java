...
public class SnakeCaseTextPlaceholder extends Placeholder {
    ...
    public String getReplacementFor(DeserializedPlaceholderString dps) {
        try {
            ...
            LOGGER.error("[FANCYMENU] Failed to parse 'Snake Case Text' placeholder!", ex);
        }
        return null;
    }
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("fancymenu.placeholders.snake_case_text");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines("fancymenu.placeholders.snake_case_text.desc"));
    }
