...
public class IsRealTimeHourRequirement extends Requirement {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.requirements.realtime_hour");
    }

    @Override
    public Component getDescription() {
        return Component.translatable("fancymenu.requirements.realtime_hour.desc");
    }
    ...
    public Component getValueDisplayName() {
        return Component.translatable("fancymenu.requirements.realtime_hour.value_name");
    }
