...
public class ListenerHandler {
    ...
    static synchronized void replaceInstancesInternal(@NotNull Collection<ListenerInstance> replacements) {
    ...
    @NotNull
    static synchronized List<ListenerInstance> getInstancesSnapshot() {
