...
public class IsRainingRequirement extends Requirement {
    ...
    private static boolean isRainingAt(@NotNull Level level, @NotNull BlockPos pos) {
        ...
        return (biome.getPrecipitation() != Biome.Precipitation.NONE) && !biome.coldEnoughToSnow(pos);
    }

    @Override
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.requirements.world.is_raining");
    }

    @Override
    public Component getDescription() {
        return Component.translatable("fancymenu.requirements.world.is_raining.desc");
    }
