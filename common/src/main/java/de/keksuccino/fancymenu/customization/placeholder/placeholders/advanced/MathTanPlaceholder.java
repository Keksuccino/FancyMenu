...
public class MathTanPlaceholder extends Placeholder {
    ...
    public String getReplacementFor(DeserializedPlaceholderString dps) {
        ...
        LOGGER.error("[FANCYMENU] Failed to parse 'Trigonometric Tangent (Math)' placeholder: " + dps.placeholderString);
        return null;
    }
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("fancymenu.placeholders.math_tan");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines("fancymenu.placeholders.math_tan.desc"));
    }
