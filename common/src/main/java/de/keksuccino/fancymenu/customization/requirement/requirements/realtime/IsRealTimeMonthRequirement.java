...
public class IsRealTimeMonthRequirement extends Requirement {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.requirements.realtime_month");
    }

    @Override
    public Component getDescription() {
        return Component.translatable("fancymenu.requirements.realtime_month.desc");
    }
    ...
    public Component getValueDisplayName() {
        return Component.translatable("fancymenu.requirements.realtime_month.value_name");
    }
