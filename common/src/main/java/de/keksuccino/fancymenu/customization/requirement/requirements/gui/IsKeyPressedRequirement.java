...
public class IsKeyPressedRequirement extends Requirement {
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("fancymenu.requirements.is_key_pressed");
    }

    @Override
    public Component getDescription() {
        return Component.translatable("fancymenu.requirements.is_key_pressed.desc");
    }
    ...
    public static com.mojang.blaze3d.platform.InputConstants.Key getKey(int keyCode) {
        ...
        try {
            key = InputConstants.getKey(new KeyEvent(keyCode, -1, 0));
