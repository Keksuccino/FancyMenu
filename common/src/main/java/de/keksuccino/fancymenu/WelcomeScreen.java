...
public class WelcomeScreen extends ModernScreen {
    ...
    private final Component headline = Components.translatable("fancymenu.welcome.screen.headline").withStyle(Style.EMPTY.withBold(true));
    private ScrollableMarkdownRenderer markdownRenderer;
    private final Font font = Minecraft.getInstance().font;

    public WelcomeScreen(@Nullable Screen parent) {
        super(Components.translatable("fancymenu.welcome.screen.title"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new ExtendedButton(centerX - 100, this.height - (FOOTER_HEIGHT / 2) - 10, 200, 20, Components.translatable("fancymenu.welcome.screen.open_docs"), button -> {
            try {
