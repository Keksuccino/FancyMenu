...
void main() {
    ...
    // Keep this literal synchronized with GuiBlurRadius.MAX_RADIUS; Minecraft 1.21.1 shader programs cannot accept compile-time defines.
    float actualRadius = clamp(round(Radius * RadiusMultiplier), 0.0, 16.0);
