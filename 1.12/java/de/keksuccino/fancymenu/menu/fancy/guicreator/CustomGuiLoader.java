...
public class CustomGuiLoader {
	...
	public static CustomGuiBase getGui(String identifier, @Nullable GuiScreen parent, @Nullable GuiScreen overrides) {
	...
	public static CustomGuiBase getGui(String identifier, @Nullable GuiScreen parent, @Nullable GuiScreen overrides, Consumer<CustomGuiBase> onClose) {
		if (guiExists(identifier)) {
			PropertiesSection sec = screens.get(identifier);
			boolean esc = true;
			if (sec.getEntryValue("allowesc").equalsIgnoreCase("false")) {
