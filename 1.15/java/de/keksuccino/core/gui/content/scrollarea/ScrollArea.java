...
public class ScrollArea extends AbstractGui {
	...
	protected void renderScrollbar() {
		if (this.height < this.entryheight) {
			...
			if (!this.isGrabberHovered()) {
				fill(this.x + this.width, this.y + this.scrollpos, this.x + this.width + grabberwidth, this.y + this.scrollpos + grabberheight, Color.GRAY.getRGB());
			} else {
				fill(this.x + this.width, this.y + this.scrollpos, this.x + this.width + grabberwidth, this.y + this.scrollpos + grabberheight, Color.LIGHT_GRAY.getRGB());
			}
	...
	protected void renderBackground() {
		...
		fill(this.x, this.y, this.x + this.width, this.y + this.height, this.backgroundColor.getRGB());
