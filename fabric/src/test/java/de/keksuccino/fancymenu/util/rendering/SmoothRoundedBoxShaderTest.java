...
class SmoothRoundedBoxShaderTest {
    ...
    @Test
    void rectangleShadersUseSharedSharpCornerCoverage() throws IOException {
        String sharedCoverage = readResource("/assets/fancymenu/shaders/include/fancymenu_rounded_box.glsl");
        String imageRectangleShader = readResource("/assets/minecraft/shaders/core/fancymenu_gui_smooth_image_rect.fsh");
        String rectangleShader = readResource("/assets/minecraft/shaders/core/fancymenu_gui_smooth_rect.fsh");
        String blurShader = readResource("/assets/minecraft/shaders/post/fancymenu_gui_blur.fsh");
        ...
        assertTrue(imageRectangleShader.contains(SHARED_COVERAGE_IMPORT));
        assertEquals(1, countOccurrences(imageRectangleShader, "fancymenuRoundedBoxAlpha("));
        assertTrue(rectangleShader.contains(SHARED_COVERAGE_IMPORT));
        assertEquals(2, countOccurrences(rectangleShader, "fancymenuRoundedBoxAlpha("));
        assertTrue(blurShader.contains(SHARED_COVERAGE_IMPORT));
        assertEquals(1, countOccurrences(blurShader, "fancymenuRoundedBoxAlpha("));
    }
