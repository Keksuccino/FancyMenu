...
class RunningElementAnimationTest {
    ...
    @Test
    void replacingTargetRestoresTheOldInstanceAndCapturesTheNewInstance() {
        ...
        RunningElementAnimation animation = animation(controller, originalTarget);
    ...
    private static RunningElementAnimation animation(AnimationControllerElement controller, AnimationControllerElement targetElement) {
        AnimationKeyframe keyframe = new AnimationKeyframe(0L, 0, 0, 0, 0, ElementAnchorPoints.TOP_LEFT, false);
        return new RunningElementAnimation(List.of(keyframe), 0L, targetElement, controller);
    }
