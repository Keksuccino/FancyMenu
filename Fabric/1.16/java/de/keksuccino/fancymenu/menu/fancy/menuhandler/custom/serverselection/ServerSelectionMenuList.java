...
public class ServerSelectionMenuList extends MultiplayerServerListWidget {

	private MenuHandlerBase handler;
	
	public ServerSelectionMenuList(MultiplayerScreen ownerIn, MinecraftClient mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn, MenuHandlerBase handler) {
