...
public class PlayerEntityCustomizationItem extends CustomizationItemBase {
	...
	private static World getDummyWorld() {
		DimensionType t = DynamicRegistryManager.create().getDimensionTypes().getOrThrow(DimensionType.OVERWORLD_REGISTRY_KEY);
		World w = new World(null, null, t, null, false, false, 239239L) {
			@Override
	...
	public static class MenuPlayerEntity extends PlayerEntity {
		...
		public MenuPlayerEntity(String playerName) {
			super(DUMMY_WORLD, BLOCK_POS, 0, new GameProfile(PlayerEntity.getOfflinePlayerUuid(getRawPlayerName(playerName)), getRawPlayerName(playerName)));
			if (playerName != null) {
