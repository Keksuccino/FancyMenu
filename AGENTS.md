...
- FancyMenu is a Minecraft Java 1.19.2 mod that uses the MultiLoader layout with shared logic under `common` and loader-specific wrappers under `fabric` and `forge`.
...
## Gradle
- Do NOT run or compile the project via Gradle, except the user explicitly tells you to do so. NEVER use any Gradle commands directly!
