...
The Minecraft sources also contain JOML sources.

## LWJGL Sources
You have access to the full LWJGL library sources of the LWJGL version used in Minecraft 1.21.8 in the `lwjgl_library_cached_sources` folder. Make sure to check the sources when working on GUI tasks that involve working with raw OpenGL.
