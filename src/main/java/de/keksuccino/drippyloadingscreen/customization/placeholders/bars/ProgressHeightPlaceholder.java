...
public class ProgressHeightPlaceholder extends Placeholder {

    public ProgressHeightPlaceholder() {
        super("drippy_progress_h");
    }
        ...
        if (id != null) {
            ...
            if (element != null) {
                if (element instanceof AbstractProgressBarCustomizationItem) {
                    return "" + ((AbstractProgressBarCustomizationItem)element).getProgressHeight();
                }
            }
        }
        return null;
    ...
    public String getDisplayName() {
        return I18n.get("drippyloadingscreen.placeholders.bars.progress.height");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(StringUtils.splitLines(I18n.get("drippyloadingscreen.placeholders.bars.progress.height.desc"), "\n"));
    }
