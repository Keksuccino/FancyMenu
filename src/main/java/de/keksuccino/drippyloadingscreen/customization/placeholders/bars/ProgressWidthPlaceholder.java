...
public class ProgressWidthPlaceholder extends Placeholder {

    public ProgressWidthPlaceholder() {
        super("drippy_progress_w");
    }
        ...
        if (id != null) {
            ...
            if (element != null) {
                if (element instanceof AbstractProgressBarCustomizationItem) {
                    return "" + ((AbstractProgressBarCustomizationItem)element).getProgressWidth();
                }
            }
        }
        return null;
    ...
    public String getDisplayName() {
        return I18n.get("drippyloadingscreen.placeholders.bars.progress.width");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(StringUtils.splitLines(I18n.get("drippyloadingscreen.placeholders.bars.progress.width.desc"), "\n"));
    }
