...
public class ExampleButtonActionContainerWithValue extends ButtonActionContainer {
    ...
    public void execute(String value) {
        ...
        //This will open a new instance of the message screen, when a button with this custom action is getting clicked
        //and will show the action value as message
        if (value != null) {
            Minecraft.getMinecraft().displayGuiScreen(new GuiMessageDialog(new GuiMainMenu(), "Message", new TextComponentString(value), "Back"));
        }
