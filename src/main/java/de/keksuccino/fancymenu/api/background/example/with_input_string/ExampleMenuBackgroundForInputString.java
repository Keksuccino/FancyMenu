        ...
        try {
            ...
            if ((this.imageLocation != null) && this.imageLocation.isReady()) {
                ...
                if (!keepAspectRatio) {
                    ...
                    DrawableHelper.drawTexture(matrix, 0, 0, 1.0F, 1.0F, screen.width, screen.height, screen.width, screen.height);
                ...
                //As soon as it's not possible to keep the aspect ratio anymore, just stretch it.
                    ...
                    if (wfinal < screen.width) {
                        ...
                        DrawableHelper.drawTexture(matrix, screenCenterX - (wfinal / 2), 0, 1.0F, 1.0F, wfinal, screen.height, wfinal, screen.height);
                    }
