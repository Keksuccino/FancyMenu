        ...
        try {
            ...
            if ((this.imageLocation != null) && this.imageLocation.isReady()) {
                ...
                if (!keepAspectRatio) {
                    ...
                    AbstractGui.blit(matrix, 0, 0, 1.0F, 1.0F, screen.width, screen.height, screen.width, screen.height);
                ...
                //As soon as it's not possible to keep the aspect ratio anymore, just stretch it.
                    ...
                    if (wfinal < screen.width) {
                        ...
                        AbstractGui.blit(matrix, screenCenterX - (wfinal / 2), 0, 1.0F, 1.0F, wfinal, screen.height, wfinal, screen.height);
                    }
