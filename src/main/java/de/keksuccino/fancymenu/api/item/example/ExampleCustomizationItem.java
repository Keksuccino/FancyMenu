...
public class ExampleCustomizationItem extends CustomizationItem {
    ...
    public void render(GuiScreen menu) throws IOException {
        ...
        if (this.shouldRender()) {
            ...
            drawRect(x, y, x + this.getWidth(), y + this.getHeight(), this.backgroundColor.getRGB() | MathHelper.ceil(this.opacity * 255.0F) << 24);
            ...
            if (this.displayText != null) {
                ...
                drawString(Minecraft.getMinecraft().fontRenderer, text, x + 10, y + 10, -1 | MathHelper.ceil(this.opacity * 255.0F) << 24);
            }
