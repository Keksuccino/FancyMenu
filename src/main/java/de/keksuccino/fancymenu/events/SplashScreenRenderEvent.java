...
public class SplashScreenRenderEvent extends Event {
    ...
    public SplashScreenRenderEvent(ResourceLoadProgressGui screen, int mouseX, int mouseY, float partialTicks, int screenWidth, int screenHeight) {
        this.screen = screen;
        this.mouseX = mouseX;
        this.mouseY = mouseY;
    ...
    public static class Pre extends SplashScreenRenderEvent {
        ...
        public Pre(ResourceLoadProgressGui screen, int mouseX, int mouseY, float partialTicks, int screenWidth, int screenHeight) {
            super(screen, mouseX, mouseY, partialTicks, screenWidth, screenHeight);
        }
    ...
    public static class Post extends SplashScreenRenderEvent {
        ...
        public Post(ResourceLoadProgressGui screen, int mouseX, int mouseY, float partialTicks, int screenWidth, int screenHeight) {
            super(screen, mouseX, mouseY, partialTicks, screenWidth, screenHeight);
        }
