...
public class IsWindowWidthRequirement extends LoadingRequirement {
    ...
    public boolean isRequirementMet( String value) {
        if (value != null) {
            ...
            if (!l.isEmpty()) {
                return l.contains(Minecraft.getMinecraft().displayWidth);
            }
        }
        return false;
    }
    ...
    public List<String> getDescription() {
        return Arrays.asList(StringUtils.splitLines(Locals.localize("fancymenu.helper.editor.items.visibilityrequirements.windowwidth.desc", "" + Minecraft.getMinecraft().displayWidth, "" + Minecraft.getMinecraft().displayHeight), "%n%"));
    }
