...
public class IsWindowHeightBiggerThanRequirement extends LoadingRequirement {
    ...
    public boolean isRequirementMet( String value) {
        if (value != null) {
            ...
            if (MathUtils.isDouble(value)) {
                return Minecraft.getMinecraft().displayHeight > (int)Double.parseDouble(value);
            }
        }
        return false;
    }
    ...
    public List<String> getDescription() {
        return Arrays.asList(StringUtils.splitLines(Locals.localize("fancymenu.helper.editor.items.visibilityrequirements.windowheightbiggerthan.desc", "" + Minecraft.getMinecraft().displayWidth, "" + Minecraft.getMinecraft().displayHeight), "%n%"));
    }
