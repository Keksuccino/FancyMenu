...
public class RandomTextPlaceholder extends Placeholder {
    ...
    public String getReplacementFor(DeserializedPlaceholderString dps) {
        ...
        if ((pathString != null) && (intervalString != null)) {
            ...
            if (!path.exists() || !path.getAbsolutePath().replace("\\", "/").startsWith(FancyMenu.getGameDirectory().getAbsolutePath().replace("\\", "/"))) {
                path = new File(FancyMenu.getGameDirectory(), pathString);
            }
