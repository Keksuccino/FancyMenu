...
public class PreloadedLayoutEditorScreen extends LayoutEditorScreen {
	...
	public PreloadedLayoutEditorScreen(GuiScreen screenToCustomize, List<PropertiesSet> properties) {
					...
					if (action.equalsIgnoreCase("texturizebackground")) {
						...
						if (value != null) {
							...
							if (!f.exists() || !f.getAbsolutePath().replace("\\", "/").startsWith(Minecraft.getMinecraft().mcDataDir.getAbsolutePath().replace("\\", "/"))) {
								valueFinal = Minecraft.getMinecraft().mcDataDir.getAbsolutePath().replace("\\", "/") + "/" + value;
						...
						if (b != null) {
							...
							if ((backNormal != null) || (backHover != null) || (backAniNormal != null) || (backAniHover != null)) {
								if (backNormal != null) {
									...
									if (!f.exists() || !f.getAbsolutePath().replace("\\", "/").startsWith(Minecraft.getMinecraft().mcDataDir.getAbsolutePath().replace("\\", "/"))) {
										f = new File(Minecraft.getMinecraft().mcDataDir.getAbsolutePath().replace("\\", "/") + "/" + backNormal.replace("\\", "/"));
									}
									if (f.isFile()) {
								...
								if (backHover != null) {
									...
									if (!f.exists() || !f.getAbsolutePath().replace("\\", "/").startsWith(Minecraft.getMinecraft().mcDataDir.getAbsolutePath().replace("\\", "/"))) {
										f = new File(Minecraft.getMinecraft().mcDataDir.getAbsolutePath().replace("\\", "/") + "/" + backHover.replace("\\", "/"));
									}
									if (f.isFile()) {
					...
					if (action.equalsIgnoreCase("addhoversound")) {
						if (b != null) {
							...
							if (path != null) {
								...
								if (!f.exists() || !f.getAbsolutePath().replace("\\", "/").startsWith(Minecraft.getMinecraft().mcDataDir.getAbsolutePath().replace("\\", "/"))) {
									f = new File(Minecraft.getMinecraft().mcDataDir.getAbsolutePath().replace("\\", "/") + "/" + path);
								}
