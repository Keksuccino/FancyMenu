...
public class IsTextVisibilityRequirement extends VisibilityRequirement {

    private static final Logger LOGGER = LogManager.getLogger();

    public IsTextVisibilityRequirement() {
...
//                LOGGER.info("###################### IS TEXT: SEC: " + s);
    ...
    public String getValuePreset() {
        return "[\"mode\":\"...\",\"text\":\"...\",\"compare_with\":\"...\"]$,[\"mode\":\"...\",\"text\":\"...\",\"compare_with\":\"...\"]$";
    }
