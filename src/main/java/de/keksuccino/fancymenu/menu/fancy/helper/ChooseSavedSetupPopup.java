...
public class ChooseSavedSetupPopup extends FMPopup {
    ...
    public void render(MatrixStack matrix, int mouseX, int mouseY, Screen renderIn) {
        ...
        drawCenteredString(matrix, MinecraftClient.getInstance().textRenderer, "§l" + Locals.localize("fancymenu.helper.setupsharing.import.choosefromsaved"), renderIn.width / 2, 17, Color.WHITE.getRGB());
