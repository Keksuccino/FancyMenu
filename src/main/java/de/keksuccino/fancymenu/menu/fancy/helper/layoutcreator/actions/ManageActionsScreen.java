...
public class ManageActionsScreen extends Screen {
    ...
    public ManageActionsScreen(@Nullable Screen parentScreen, @NotNull List<ActionInstance> instances, @NotNull Consumer<List<ActionInstance>> callback) {
        ...
        super(new TextComponent(Locals.localize("fancymenu.editor.action.screens.manage_screen.manage")));
    ...
    public static class ActionInstanceEntry extends ScrollAreaEntry {
        ...
        public ActionInstanceEntry(ScrollArea parent, ActionInstance instance, int lineHeight) {
            ...
            this.displayNameComponent = new TextComponent(this.instance.action.getAction()).setStyle(Style.EMPTY.withColor(TEXT_COLOR_GRAY_1.getRGB()));
            ...
            this.valueComponent = new TextComponent(Locals.localize("fancymenu.editor.action.screens.manage_screen.info.value") + " ").setStyle(Style.EMPTY.withColor(TEXT_COLOR_GRAY_1.getRGB())).append(new TextComponent(valueString).setStyle(Style.EMPTY.withColor(TEXT_COLOR_GREY_4.getRGB())));
