...
public class ManageActionsScreen extends Screen {
    ...
    public ManageActionsScreen( Screen parentScreen,  List<ActionInstance> instances,  Consumer<List<ActionInstance>> callback) {
        ...
        super(new StringTextComponent(Locals.localize("fancymenu.editor.action.screens.manage_screen.manage")));
    ...
    public static class ActionInstanceEntry extends ScrollAreaEntry {
        ...
        public ActionInstanceEntry(ScrollArea parent, ActionInstance instance, int lineHeight) {
            ...
            this.displayNameComponent = new StringTextComponent(this.instance.action.getAction()).setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GRAY_1.getRGB())));
            ...
            this.valueComponent = new StringTextComponent(Locals.localize("fancymenu.editor.action.screens.manage_screen.info.value") + " ").setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GRAY_1.getRGB()))).append(new StringTextComponent(valueString).setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GREY_4.getRGB()))));
