...
public class ManageActionsScreen extends Screen {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        UIBase.drawStringWithoutShadow(graphics, font, Locals.localize("fancymenu.editor.action.screens.manage_screen.actions"), 20, 50, -1);
    ...
    public static class ActionInstanceEntry extends ScrollAreaEntry {
        ...
        public void render(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
            ...
            UIBase.drawStringWithoutShadow(graphics, font, this.valueComponent, (float)(this.getX() + 5 + 4 + 3 + 4 + 3), (float)(centerYLine2 - (this.font.lineHeight / 2)), -1);
