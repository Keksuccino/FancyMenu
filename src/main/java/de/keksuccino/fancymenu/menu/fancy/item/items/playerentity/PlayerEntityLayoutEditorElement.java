...
public class PlayerEntityLayoutEditorElement extends LayoutEditorElement {
    ...
    public void init() {
        ...
        AdvancedButton setPlayerNameButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancymenu.helper.editor.items.playerentity.set_player_name"), true, (press) -> {
            TextEditorScreen s = new TextEditorScreen(new TextComponent(Locals.localize("fancymenu.helper.editor.items.playerentity.set_player_name")), this.handler, null, (call) -> {
                if (call != null) {
        ...
        AdvancedButton setWebSkinButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancymenu.helper.editor.items.playerentity.skin.set.web"), true, (press) -> {
            TextEditorScreen s = new TextEditorScreen(new TextComponent(Locals.localize("fancymenu.helper.editor.items.playerentity.skin.set.web")), this.handler, null, (call) -> {
                if (call != null) {
                    if (!call.replace(" ", "").equals("")) {
        ...
        AdvancedButton setWebCapeButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancymenu.helper.editor.items.playerentity.cape.set.web"), true, (press) -> {
            TextEditorScreen s = new TextEditorScreen(new TextComponent(Locals.localize("fancymenu.helper.editor.items.playerentity.cape.set.web")), this.handler, null, (call) -> {
                if (call != null) {
                    if (!call.replace(" ", "").equals("")) {
