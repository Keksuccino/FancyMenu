...
public class ScrollBar extends AbstractGui {
    ...
    public ScrollBar( ScrollBarDirection direction, int grabberWidth, int grabberHeight, int scrollAreaStartX, int scrollAreaStartY, int scrollAreaEndX, int scrollAreaEndY, Color idleBarColor, Color hoverBarColor) {
    ...
    public ScrollBar( ScrollBarDirection direction, int grabberWidth, int grabberHeight, int scrollAreaStartX, int scrollAreaStartY, int scrollAreaEndX, int scrollAreaEndY, ResourceLocation idleBarTexture, ResourceLocation hoverBarTexture) {
        this(direction, grabberWidth, grabberHeight, scrollAreaStartX, scrollAreaStartY, scrollAreaEndX, scrollAreaEndY);
    ...
    public void render() {
        ...
        if (this.isGrabberHovered() || this.isGrabberGrabbed()) {
            if (this.hoverBarTexture != null) {
                Minecraft.getMinecraft().getTextureManager().bindTexture(this.hoverBarTexture);
                blit(x, y, 0.0F, 0.0F, this.grabberWidth, this.grabberHeight, this.grabberWidth, this.grabberHeight);
            } else if (this.hoverBarColor != null) {
                fill(x, y, x + this.grabberWidth, y + this.grabberHeight, this.hoverBarColor.getRGB());
            }
        } else {
            if (this.idleBarTexture != null) {
                Minecraft.getMinecraft().getTextureManager().bindTexture(this.idleBarTexture);
                blit(x, y, 0.0F, 0.0F, this.grabberWidth, this.grabberHeight, this.grabberWidth, this.grabberHeight);
            } else if (this.idleBarColor != null) {
                fill(x, y, x + this.grabberWidth, y + this.grabberHeight, this.idleBarColor.getRGB());
            }
        }
    ...
    protected void handleWheelScrolling(MouseInput.MouseData e) {
