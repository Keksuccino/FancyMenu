...
//
//public class HideForPopup extends FMTextInputPopup {
//	
...
//		
//		AbstractGui.drawCenteredString(Minecraft.getInstance().fontRenderer, new StringTextComponent(title), renderIn.width / 2, (renderIn.height / 2) - (height / 2) + 10, Color.WHITE.getRGB());
//		
