...
public abstract class TextListScrollAreaEntry extends ScrollAreaEntry {
    ...
    public TextListScrollAreaEntry(ScrollArea parent, @NotNull Component text, @NotNull Color listDotColor) {
        super(parent, 0, 16);
