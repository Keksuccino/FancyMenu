...
public class DummyWorldFactory {
	...
	public static DimensionType getDummyDimensionType() {
		return DimensionType.create(OptionalLong.of(1), false, false, false, false, 1.0, false, false, false, false, false, 16, 16, 16, null, new Identifier(""), new Identifier(""), 1.0F);
	}
