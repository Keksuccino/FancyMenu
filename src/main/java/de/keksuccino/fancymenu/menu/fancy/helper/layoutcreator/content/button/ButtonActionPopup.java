...
//
//			//Draw popup title
//			drawCenteredString(matrix, Minecraft.getInstance().font, Component.literal("§l" + Locals.localize("helper.creator.custombutton.config")), renderIn.width / 2, (renderIn.height / 2) - 50 - 40, -1);
//
//			//Draw action type name
//			drawCenteredString(matrix, Minecraft.getInstance().font, Component.literal(Locals.localize("helper.creator.custombutton.config.actiontype")), renderIn.width / 2, (renderIn.height / 2) - 60, -1);
//
...
//			}
//			drawCenteredString(matrix, Minecraft.getInstance().font, Component.literal(actionDesc), renderIn.width / 2, (renderIn.height / 2) - 20, Color.WHITE.getRGB());
//
...
//				}
//				drawCenteredString(matrix, Minecraft.getInstance().font, Component.literal(Locals.localize("helper.creator.custombutton.config.actionvalue", valueDesc)), renderIn.width / 2, (renderIn.height / 2) + 15, Color.WHITE.getRGB());
//
...
//				}
//				drawCenteredString(matrix, Minecraft.getInstance().font, Component.literal(Locals.localize("helper.creator.custombutton.config.actionvalue.example", valueExample)), renderIn.width / 2, (renderIn.height / 2) + 56, Color.WHITE.getRGB());
//			}
//
