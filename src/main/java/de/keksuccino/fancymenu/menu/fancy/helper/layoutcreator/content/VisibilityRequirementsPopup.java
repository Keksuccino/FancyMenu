...
public class VisibilityRequirementsPopup extends FMPopup {
    ...
    public void render(int mouseX, int mouseY, GuiScreen renderIn) {
        ...
        this.doneButton.x = centerX - (this.doneButton.width / 2);
        this.doneButton.y = centerY + 50;

        this.leftButton.x = centerX - this.leftButton.width - 135;
        this.leftButton.y = centerY - (this.leftButton.height / 2);

        this.rightButton.x = centerX + 135;
        this.rightButton.y = centerY - (this.leftButton.height / 2);

        Requirement r = this.requirements.get(this.currentRequirement);
        if (r != null) {
            r.render(mouseX, mouseY, renderIn);
        }
    ...
    public static class Requirement extends Gui {
        ...
        protected void init() {
            ...
            if ((this.valueCallback != null) && (this.valueName != null)) {
                this.valueTextField = new AdvancedTextField(Minecraft.getMinecraft().fontRenderer, 0, 0, 150, 20, true, this.valueFilter);
        ...
        public void render(int mouseX, int mouseY, GuiScreen renderIn) {
            ...
            drawCenteredString(Minecraft.getMinecraft().fontRenderer, Locals.localize("fancymenu.helper.editor.items.visibilityrequirements.requirement") + ":", centerX, centerY - 83, -1);
            this.enableRequirementButton.x = centerX - (this.enableRequirementButton.width / 2);
            this.enableRequirementButton.y = centerY - 70;

            this.showIfButton.x = centerX - this.showIfButton.width - 5;
            ...
            if (this.valueTextField != null) {
                drawCenteredString(Minecraft.getMinecraft().fontRenderer, this.valueName + ":", centerX, centerY - 10, -1);
