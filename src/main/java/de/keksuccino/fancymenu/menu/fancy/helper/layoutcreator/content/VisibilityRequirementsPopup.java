...
public class VisibilityRequirementsPopup extends FMPopup {
    ...
    protected void initRequirements() {
        ...
        String languageValuePreset = Minecraft.getInstance().gameSettings.language;
    ...
    public static class Requirement extends AbstractGui {
        ...
        public void render(MatrixStack matrix, int mouseX, int mouseY, Screen renderIn) {
            ...
            drawCenteredString(matrix, Minecraft.getInstance().fontRenderer, Locals.localize("fancymenu.helper.editor.items.visibilityrequirements.requirement") + ":", centerX, centerY - 83, -1);
