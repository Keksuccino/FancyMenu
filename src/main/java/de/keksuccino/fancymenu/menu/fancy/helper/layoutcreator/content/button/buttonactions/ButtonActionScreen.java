...
public class ButtonActionScreen extends ScrollableScreen {
    ...
    public void render(PoseStack matrix, int mouseX, int mouseY, float partialTicks) {
        ...
        if (selected.hasValue) {
            ...
            //Action Value
            drawCenteredString(matrix, font, new TextComponent(Locals.localize("helper.creator.custombutton.config.actionvalue", selected.valueDesc)), xCenter, this.height - 100, -1);
            ...
            drawCenteredString(matrix, font, new TextComponent(Locals.localize("helper.creator.custombutton.config.actionvalue.example", selected.valueExample)), xCenter, this.height - 60, -1);
