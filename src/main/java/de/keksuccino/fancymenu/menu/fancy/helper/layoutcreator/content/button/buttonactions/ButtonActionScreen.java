...
public class ButtonActionScreen extends ScrollableScreen {
    ...
    public boolean isOverlayButtonHovered() {
        return this.doneButton.isHovered();
    }
    ...
    public void render(MatrixStack matrix, int mouseX, int mouseY, float partialTicks) {
        ...
        if (selected.hasValue) {
            ...
            //Action Value
            drawCenteredString(matrix, font, new StringTextComponent(Locals.localize("helper.creator.custombutton.config.actionvalue", selected.valueDesc)), xCenter, this.height - 100, -1);
            ...
            drawCenteredString(matrix, font, new StringTextComponent(Locals.localize("helper.creator.custombutton.config.actionvalue.example", selected.valueExample)), xCenter, this.height - 60, -1);
    ...
    public static class ButtonAction extends AbstractGui {
        ...
        public void render(MatrixStack matrix, int mouseX, int mouseY, ButtonActionScrollEntry entry) {
