...
public abstract class CustomizationItemBase extends Gui {
	...
	public int getOrientationElementPosX(GuiScreen menu) {
		if (this.orientationElement != null) {
			if (this.orientationElement instanceof VanillaButtonCustomizationItem) {
				GuiButton w = ((VanillaButtonCustomizationItem)this.orientationElement).parent.getButton();
				if (w != null) {
					return w.x;
				}
			} else {
	...
	public int getOrientationElementPosY(GuiScreen menu) {
		if (this.orientationElement != null) {
			if (this.orientationElement instanceof VanillaButtonCustomizationItem) {
				GuiButton w = ((VanillaButtonCustomizationItem)this.orientationElement).parent.getButton();
				if (w != null) {
