...
//
//public class LayoutSavePopup extends FMPopup {
//	
...
//				AbstractGui.drawCenteredString(Minecraft.getInstance().fontRenderer, new StringTextComponent(s), renderIn.width / 2, (renderIn.height / 2) - (height / 2) + 10 + i, Color.WHITE.getRGB());
//				i += 10;
//			}
//			
