...
public class VisibilityRequirementHandler {
    ...
    public static void update() {
        ...
        //VR: World Loaded
        worldLoaded = (Minecraft.getMinecraft().world != null);

        //VR: Is Singleplayer & Is Multiplayer
        isSingleplayer = Minecraft.getMinecraft().isIntegratedServerRunning();
        if (!worldLoaded) {
        ...
        windowWidth = MainWindowHandler.getScaledWidth();
        windowHeight = MainWindowHandler.getScaledHeight();
