...
public class ButtonCustomizationItem extends CustomizationItemBase {
	...
	public void render(MatrixStack matrix, Screen menu) throws IOException {
		...
		if (this.onlyMultiplayer && ((MinecraftClient.getInstance().world == null) || MinecraftClient.getInstance().isInSingleplayer())) {
			return;
		}

		if (this.onlySingleplayer && ((MinecraftClient.getInstance().world == null) || !MinecraftClient.getInstance().isInSingleplayer())) {
			return;
		}
