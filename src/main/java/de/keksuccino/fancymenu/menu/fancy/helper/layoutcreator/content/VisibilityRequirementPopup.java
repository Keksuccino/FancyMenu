...
public class VisibilityRequirementPopup extends FMPopup {
    ...
    public VisibilityRequirementPopup(CustomizationItemBase parent) {
        super(240);
        this.parent = parent;
    ...
    public static class Requirement extends DrawableHelper {
        ...
        public Requirement(VisibilityRequirementPopup parent, String name, String desc, @Nullable String valueName, boolean enabled, boolean showIf, Consumer<Boolean> enabledCallback, Consumer<Boolean> showIfCallback, @Nullable Consumer<String> valueCallback, CharacterFilter valueFilter, String valueString) {
            this.parent = parent;
            this.name = name;
            this.desc = desc;
        ...
        public void render(MatrixStack matrix, int mouseX, int mouseY, Screen renderIn) {
            ...
            drawCenteredText(matrix, MinecraftClient.getInstance().textRenderer, Locals.localize("fancymenu.helper.editor.items.visibilityrequirements.requirement") + ":", centerX, centerY - 83, -1);
            ...
            if (this.valueTextField != null) {
                drawCenteredText(matrix, MinecraftClient.getInstance().textRenderer, this.valueName + ":", centerX, centerY - 10, -1);
