...
public class ManageRequirementsScreen extends Screen {
    ...
    public ManageRequirementsScreen(@Nullable Screen parentScreen, @NotNull LoadingRequirementContainer container, @NotNull Consumer<LoadingRequirementContainer> callback) {
        ...
        super(new TextComponent(Locals.localize("fancymenu.editor.loading_requirement.screens.manage_screen.manage")));
    ...
    public static class RequirementGroupEntry extends TextListScrollAreaEntry {
        ...
        public RequirementGroupEntry(ScrollArea parent, LoadingRequirementGroup group) {
            super(parent, new TextComponent(group.identifier).setStyle(Style.EMPTY.withColor(TEXT_COLOR_GRAY_1.getRGB())).append(new TextComponent(" (" + Locals.localize("fancymenu.editor.loading_requirement.screens.manage_screen.group.info", "" + group.getInstances().size()) + ")").setStyle(Style.EMPTY.withColor(TEXT_COLOR_GREY_4.getRGB()))), LISTING_DOT_ORANGE, (entry) -> {});
            this.group = group;
    ...
    public static class RequirementInstanceEntry extends ScrollAreaEntry {
        ...
        public RequirementInstanceEntry(ScrollArea parent, LoadingRequirementInstance instance, int lineHeight) {
            ...
            this.displayNameComponent = new TextComponent(this.instance.requirement.getDisplayName()).setStyle(Style.EMPTY.withColor(TEXT_COLOR_GRAY_1.getRGB()));
            ...
            this.modeComponent = new TextComponent(Locals.localize("fancymenu.editor.loading_requirement.screens.requirement.info.mode") + " ").setStyle(Style.EMPTY.withColor(TEXT_COLOR_GRAY_1.getRGB())).append(new TextComponent(modeString).setStyle(Style.EMPTY.withColor(TEXT_COLOR_GREY_4.getRGB())));
            ...
            this.valueComponent = new TextComponent(Locals.localize("fancymenu.editor.loading_requirement.screens.requirement.info.value") + " ").setStyle(Style.EMPTY.withColor(TEXT_COLOR_GRAY_1.getRGB())).append(new TextComponent(valueString).setStyle(Style.EMPTY.withColor(TEXT_COLOR_GREY_4.getRGB())));
