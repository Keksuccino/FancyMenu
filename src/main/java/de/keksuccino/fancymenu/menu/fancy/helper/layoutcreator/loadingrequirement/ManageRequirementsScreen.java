...
public class ManageRequirementsScreen extends Screen {
    ...
    public ManageRequirementsScreen( Screen parentScreen,  LoadingRequirementContainer container,  Consumer<LoadingRequirementContainer> callback) {
        ...
        super(new StringTextComponent(Locals.localize("fancymenu.editor.loading_requirement.screens.manage_screen.manage")));
    ...
    public static class RequirementGroupEntry extends TextListScrollAreaEntry {
        ...
        public RequirementGroupEntry(ScrollArea parent, LoadingRequirementGroup group) {
            super(parent, new StringTextComponent(group.identifier).setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GRAY_1.getRGB()))).append(new StringTextComponent(" (" + Locals.localize("fancymenu.editor.loading_requirement.screens.manage_screen.group.info", "" + group.getInstances().size()) + ")").setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GREY_4.getRGB())))), LISTING_DOT_ORANGE, (entry) -> {});
            this.group = group;
    ...
    public static class RequirementInstanceEntry extends ScrollAreaEntry {
        ...
        public RequirementInstanceEntry(ScrollArea parent, LoadingRequirementInstance instance, int lineHeight) {
            ...
            this.displayNameComponent = new StringTextComponent(this.instance.requirement.getDisplayName()).setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GRAY_1.getRGB())));
            ...
            this.modeComponent = new StringTextComponent(Locals.localize("fancymenu.editor.loading_requirement.screens.requirement.info.mode") + " ").setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GRAY_1.getRGB()))).append(new StringTextComponent(modeString).setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GREY_4.getRGB()))));
            ...
            this.valueComponent = new StringTextComponent(Locals.localize("fancymenu.editor.loading_requirement.screens.requirement.info.value") + " ").setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GRAY_1.getRGB()))).append(new StringTextComponent(valueString).setStyle(Style.EMPTY.withColor(Color.fromRgb(TEXT_COLOR_GREY_4.getRGB()))));
