...
public class ManageRequirementsScreen extends Screen {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        UIBase.drawStringWithoutShadow(graphics, font, titleComp, 20, 20, -1);

        UIBase.drawStringWithoutShadow(graphics, font, Locals.localize("fancymenu.editor.loading_requirement.screens.manage_screen.requirements_and_groups"), 20, 50, -1);
    ...
    public static class RequirementInstanceEntry extends ScrollAreaEntry {
        ...
        public void render(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
            ...
            UIBase.drawStringWithoutShadow(graphics, font, this.displayNameComponent, (float)(this.getX() + 5 + 4 + 3), (float)(centerYLine1 - (this.font.lineHeight / 2)), -1);

            renderListingDot(graphics, this.getX() + 5 + 4 + 3, centerYLine2 - 2, LISTING_DOT_BLUE);
            UIBase.drawStringWithoutShadow(graphics, font, this.modeComponent, (float)(this.getX() + 5 + 4 + 3 + 4 + 3), (float)(centerYLine2 - (this.font.lineHeight / 2)), -1);

            renderListingDot(graphics, this.getX() + 5 + 4 + 3, centerYLine3 - 2, LISTING_DOT_BLUE);
            UIBase.drawStringWithoutShadow(graphics, font, this.valueComponent, (float)(this.getX() + 5 + 4 + 3 + 4 + 3), (float)(centerYLine3 - (this.font.lineHeight / 2)), -1);
