...
public class LayoutPlayerEntity extends LayoutElement {
	...
	protected void renderHighlightBorder(PoseStack matrix) {
		...
		//horizontal line top
		GuiComponent.fill(matrix, this.getEntityPosX(), this.getEntityPosY(), this.getEntityPosX() + this.object.getWidth(), this.getEntityPosY() + 1, c.getRGB());
		//horizontal line bottom
		GuiComponent.fill(matrix, this.getEntityPosX(), this.getEntityPosY() + this.object.getHeight(), this.getEntityPosX() + this.object.getWidth() + 1, this.getEntityPosY() + this.object.getHeight() + 1, c.getRGB());
		//vertical line left
		GuiComponent.fill(matrix, this.getEntityPosX(), this.getEntityPosY(), this.getEntityPosX() + 1, this.getEntityPosY() + this.object.getHeight(), c.getRGB());
		//vertical line right
		GuiComponent.fill(matrix, this.getEntityPosX() + this.object.getWidth(), this.getEntityPosY(), this.getEntityPosX() + this.object.getWidth() + 1, this.getEntityPosY() + this.object.getHeight(), c.getRGB());
	}
