...
//			this.rightclickMenu.closeChilds();
		...
		//TODO übernehmen
//		UIBase.colorizeButton(playernameB);
		...
		//TODO übernehmen
//		UIBase.colorizeButton(autoPlayernameB);
		...
		//TODO übernehmen
//		UIBase.colorizeButton(setPlayernameB);
...
//		UIBase.colorizeButton(skinB);
		...
		//TODO übernehmen
//		UIBase.colorizeButton(localSkinB);
		...
		//TODO übernehmen
//		UIBase.colorizeButton(urlSkinB);
...
//		UIBase.colorizeButton(capeB);
		...
		//TODO übernehmen 
//		UIBase.colorizeButton(localCapeB);
		...
		//TODO übernehmen
//		UIBase.colorizeButton(urlCapeB);
...
//			this.rightclickMenu.closeChilds();
		...
		//TODO übernehmen
//		UIBase.colorizeButton(rotationB);
		...
		//TODO übernehmen
//		UIBase.colorizeButton(autoRotationB);
		...
		//TODO übernehmen
//		UIBase.colorizeButton(customRotationB);
		...
		AdvancedButton slimB = new AdvancedButton(0, 0, 0, 16, slimLabel, true, (press) -> {
			...
			if (this.getEntity().isSlimSkin()) {
				...
				press.setMessage(Locals.localize("helper.creator.items.playerentity.slim.off"));
			} else {
				this.getEntity().setSlimSkin(true);
				press.setMessage(Locals.localize("helper.creator.items.playerentity.slim.on"));
			}
		});
...
//		UIBase.colorizeButton(slimB);
		...
		AdvancedButton crouchingB = new AdvancedButton(0, 0, 0, 16, crouchingLabel, true, (press) -> {
			...
			if (this.getEntity().crouching) {
				...
				press.setMessage(Locals.localize("helper.creator.items.playerentity.crouching.off"));
			} else {
				this.getEntity().crouching = true;
				press.setMessage(Locals.localize("helper.creator.items.playerentity.crouching.on"));
			}
		});
		...
		//TODO übernehmen
//		UIBase.colorizeButton(crouchingB);
		...
		AdvancedButton showNameB = new AdvancedButton(0, 0, 0, 16, showNameLabel, true, (press) -> {
			...
			if (this.getEntity().showName) {
				...
				press.setMessage(Locals.localize("helper.creator.items.playerentity.showname.off"));
			} else {
				this.getEntity().showName = true;
				press.setMessage(Locals.localize("helper.creator.items.playerentity.showname.on"));
			}
		});
		...
		AdvancedButton parrotB = new AdvancedButton(0, 0, 0, 16, parrotLabel, true, (press) -> {
			...
			if (this.getEntity().hasParrot) {
				...
				press.setMessage(Locals.localize("helper.creator.items.playerentity.parrot.off"));
			} else {
				this.getEntity().hasParrot = true;
				press.setMessage(Locals.localize("helper.creator.items.playerentity.parrot.on"));
			}
		});
	...
	protected void renderBorder(int mouseX, int mouseY) {
		//horizontal line top
		fill(this.getEntityPosX(), this.getEntityPosY(), this.getEntityPosX() + this.object.width, this.getEntityPosY() + 1, Color.BLUE.getRGB());
		//horizontal line bottom
		fill(this.getEntityPosX(), this.getEntityPosY() + this.object.height, this.getEntityPosX() + this.object.width + 1, this.getEntityPosY() + this.object.height + 1, Color.BLUE.getRGB());
		//vertical line left
		fill(this.getEntityPosX(), this.getEntityPosY(), this.getEntityPosX() + 1, this.getEntityPosY() + this.object.height, Color.BLUE.getRGB());
		//vertical line right
		fill(this.getEntityPosX() + this.object.width, this.getEntityPosY(), this.getEntityPosX() + this.object.width + 1, this.getEntityPosY() + this.object.height, Color.BLUE.getRGB());
	...
	protected void renderHighlightBorder() {
		...
		//horizontal line top
		AbstractGui.fill(this.getEntityPosX(), this.getEntityPosY(), this.getEntityPosX() + this.object.width, this.getEntityPosY() + 1, c.getRGB());
		//horizontal line bottom
		AbstractGui.fill(this.getEntityPosX(), this.getEntityPosY() + this.object.height, this.getEntityPosX() + this.object.width + 1, this.getEntityPosY() + this.object.height + 1, c.getRGB());
		//vertical line left
		AbstractGui.fill(this.getEntityPosX(), this.getEntityPosY(), this.getEntityPosX() + 1, this.getEntityPosY() + this.object.height, c.getRGB());
		//vertical line right
		AbstractGui.fill(this.getEntityPosX() + this.object.width, this.getEntityPosY(), this.getEntityPosX() + this.object.width + 1, this.getEntityPosY() + this.object.height, c.getRGB());
	}
