	...
	public void render(int mouseX, int mouseY, Screen renderIn) {
		...
		if (this.isDisplayed()) {
			...
			if (s.equals(Locals.localize("helper.creator.backgroundoptions.backgroundslideshow"))) {
				...
				drawCenteredString(Minecraft.getInstance().fontRenderer, Locals.localize("helper.creator.backgroundoptions.slideshows"), renderIn.width / 2, (renderIn.height / 2) - 50, Color.WHITE.getRGB());
