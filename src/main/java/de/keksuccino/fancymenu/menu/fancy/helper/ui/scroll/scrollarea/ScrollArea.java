...
public class ScrollArea extends UIBase {
    ...
    public void renderBackground(MatrixStack matrix, int mouseX, int mouseY, float partial) {
    ...
    public void renderBorder(MatrixStack matrix, int mouseX, int mouseY, float partial) {
    ...
    public void renderEntries(MatrixStack matrix, int mouseX, int mouseY, float partial) {
