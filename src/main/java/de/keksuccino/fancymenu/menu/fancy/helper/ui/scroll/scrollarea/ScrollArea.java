...
public class ScrollArea extends UIBase {
    ...
    public void render(int mouseX, int mouseY, float partial) {
        ...
        this.renderBackground(mouseX, mouseY, partial);

        this.renderEntries(mouseX, mouseY, partial);

        this.renderBorder(mouseX, mouseY, partial);
    ...
    public void renderBackground(int mouseX, int mouseY, float partial) {
        fill(this.getInnerX(), this.getInnerY(), this.getInnerX() + this.getInnerWidth(), this.getInnerY() + this.getInnerHeight(), this.backgroundColor.getRGB());
    }

    public void renderBorder(int mouseX, int mouseY, float partial) {
        renderBorder(this.getXWithBorder(), this.getYWithBorder(), this.getXWithBorder() + this.getWidthWithBorder(), this.getYWithBorder() + this.getHeightWithBorder(), this.getBorderThickness(), this.borderColor, true, true, true, true);
    }

    public void renderEntries(int mouseX, int mouseY, float partial) {
        ...
        RenderSystem.enableScissor((int)(this.getInnerX() * scaleW), (int)(mc.displayHeight - (sciBottomY * scaleH)), (int)(this.getInnerWidth() * scaleW), (int)(this.getInnerHeight() * scaleH));
        ...
        this.updateEntries((entry) -> {
            ...
            entry.render(mouseX, mouseY, partial);
            if (cachedWidth != -1) {
    ...
    public void updateEntries( Consumer<ScrollAreaEntry> doAfterEachEntryUpdate) {
        try {
            int index = 0;
