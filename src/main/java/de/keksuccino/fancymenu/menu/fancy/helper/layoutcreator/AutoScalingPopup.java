...
public class AutoScalingPopup extends FMPopup {
    ...
    public void render(MatrixStack matrix, int mouseX, int mouseY, Screen renderIn) {
        ...
        drawCenteredText(matrix, font, Locals.localize("fancymenu.helper.editor.properties.autoscale.basesize.popup.desc.line1"), screenCenterX, screenCenterY - 90, -1);
        drawCenteredText(matrix, font, Locals.localize("fancymenu.helper.editor.properties.autoscale.basesize.popup.desc.line2"), screenCenterX, screenCenterY - 80, -1);
        drawCenteredText(matrix, font, Locals.localize("fancymenu.helper.editor.properties.autoscale.basesize.popup.desc.line3"), screenCenterX, screenCenterY - 70, -1);
        ...
        drawCenteredText(matrix, font, Locals.localize("helper.creator.windowsize.currentwidth") + ": " + MinecraftClient.getInstance().getWindow().getWidth(), screenCenterX, screenCenterY + 45, -1);
        drawCenteredText(matrix, font, Locals.localize("helper.creator.windowsize.currentheight") + ": " + MinecraftClient.getInstance().getWindow().getHeight(), screenCenterX, screenCenterY + 55, -1);
