...
public class ManageTickerActionsScreen extends ScrollableScreen {
    ...
    public boolean isOverlayButtonHovered() {
        return (this.doneButton.isHovered() || this.removeButton.isHovered() || this.editButton.isHovered());
    }
    ...
    public static class TickerActionScrollEntry extends ScrollAreaEntryBase {
        ...
        public void renderEntry(MatrixStack matrix) {
            ...
            StringTextComponent actionComp = new StringTextComponent(Locals.localize("fancymenu.customization.items.ticker.manage_actions.action", this.action.action));
            ...
            StringTextComponent valueComp = new StringTextComponent(Locals.localize("fancymenu.customization.items.ticker.manage_actions.value", valueString));
