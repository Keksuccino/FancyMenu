...
public class ManageTickerActionsScreen extends ScrollableScreen {
    ...
    public static class TickerActionScrollEntry extends ScrollAreaEntryBase {
        ...
        public void renderEntry(PoseStack matrix) {
            ...
            Component actionComp = new TextComponent(Locals.localize("fancymenu.customization.items.ticker.manage_actions.action", this.action.action));
            ...
            Component valueComp = new TextComponent(Locals.localize("fancymenu.customization.items.ticker.manage_actions.value", valueString));
