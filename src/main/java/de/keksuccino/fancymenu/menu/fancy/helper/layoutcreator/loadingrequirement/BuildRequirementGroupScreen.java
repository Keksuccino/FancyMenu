...
public class BuildRequirementGroupScreen extends Screen {
    ...
    public BuildRequirementGroupScreen( Screen parentScreen,  LoadingRequirementContainer parent,  LoadingRequirementGroup groupToEdit,  Consumer<LoadingRequirementGroup> callback) {

        super((groupToEdit != null) ? new StringTextComponent(Locals.localize("fancymenu.editor.loading_requirement.screens.edit_group")) : new StringTextComponent(Locals.localize("fancymenu.editor.loading_requirement.screens.add_group")));
