...
public class BuildRequirementGroupScreen extends Screen {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        UIBase.drawStringWithoutShadow(graphics, font, Locals.localize("fancymenu.editor.loading_requirement.screens.build_group_screen.group_requirements"), 20, 50, -1);
        ...
        UIBase.drawStringWithoutShadow(graphics, font, idLabel, this.width - 20 - idLabelWidth, this.groupIdentifierTextField.getY() - 15, -1);
