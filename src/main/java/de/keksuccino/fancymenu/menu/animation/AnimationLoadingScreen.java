	...
	public void render(PoseStack matrix, int p_render_1_, int p_render_2_, float p_render_3_) {
		...
		if (current == null) {
			...
			if (this.fallback != null) {
				Minecraft.getInstance().setScreen(this.fallback);
...
//				}
		...
		if (this.specialString != null) {
			...
			int i = r.width(this.specialString) / 2;
			r.drawShadow(matrix, this.specialString, (this.width / 2) - i, 20, Color.WHITE.getRGB());
		}
