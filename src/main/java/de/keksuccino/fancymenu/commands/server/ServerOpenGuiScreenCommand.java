...
public class ServerOpenGuiScreenCommand {
    ...
    private static final Logger LOGGER = LogManager.getLogger("fancymenu/ServerOpenGuiScreenCommand");
    ...
    private static int openGui(CommandSourceStack stack, String menuIdentifierOrCustomGuiName) {
        try {
            ...
            stack.sendFailure(new TextComponent("Error while trying to execute command!"));
            e.printStackTrace();
        }
        return 1;
    }
