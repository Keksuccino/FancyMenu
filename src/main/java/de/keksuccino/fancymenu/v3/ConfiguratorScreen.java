...
import de.keksuccino.fancymenu.v3.input.InputConstants;
...
public abstract class ConfiguratorScreen extends Screen {
    ...
    protected void init() {
        ...
        this.cancelButton = this.addRightSideButton(20, Component.literal(Locals.localize("fancymenu.guicomponents.cancel")),button -> {
            this.onCancel();
        });

        this.doneButton = this.addRightSideButton(20, Component.literal(Locals.localize("fancymenu.guicomponents.done")), button -> {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        graphics.fill(0, 0, this.width, this.height, UIBase.screen_background_color.getColorInt());

        Component titleComp = this.title.copy().withStyle(Style.EMPTY.withBold(true));
        graphics.drawString(this.font, titleComp, 20, 20, UIBase.generic_text_base_color.getColorInt(), false);
    ...
    public class SeparatorCell extends RenderCell {
        ...
        protected Supplier<DrawableColor> separatorColorSupplier = () -> UIBase.element_border_color_normal;
    ...
    public class TextInputCell extends RenderCell {
        ...
        public TextInputCell(@Nullable CharacterFilter characterFilter, boolean allowEditor, boolean allowEditorPlaceholders) {
            ...
            if (this.allowEditor) {
                this.openEditorButton = new ExtendedButton(0, 0, 20, 20, Component.literal(Locals.localize("fancymenu.ui.screens.string_builder_screen.edit_in_editor")), button -> {
                    if (allowEditor) {
                        TextEditorScreen s = new TextEditorScreen(ConfiguratorScreen.this, (characterFilter != null) ? characterFilter.convertToLegacyFilter() : null, callback -> {
                            if (callback != null) {
...
//            this.editBox.tick();
    ...
    public abstract class RenderCell extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
        ...
        protected Supplier<DrawableColor> hoverColorSupplier = () -> UIBase.list_entry_color_selected_hovered;
