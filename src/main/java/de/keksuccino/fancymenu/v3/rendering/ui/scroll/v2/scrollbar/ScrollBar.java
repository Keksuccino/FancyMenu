package de.keksuccino.fancymenu.v3.rendering.ui.scroll.v2.scrollbar;
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        if (this.isGrabberHovered() || this.isGrabberGrabbed()) {
            if (this.hoverBarTexture != null) {
                ...
                blitF(graphics.pose(), x, y, 0.0F, 0.0F, this.grabberWidth, this.grabberHeight, this.grabberWidth, this.grabberHeight);
            } else if (hoverC != null) {
                fillF(graphics.pose(), x, y, x + this.grabberWidth, y + this.grabberHeight, hoverC.getColorInt());
            }
        } else {
            if (this.idleBarTexture != null) {
                ...
                fillF(graphics.pose(), x, y, x + this.grabberWidth, y + this.grabberHeight, normalC.getColorInt());
            }
        }
