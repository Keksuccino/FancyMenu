...
//				TooltipHandler.INSTANCE.addWidgetTooltip(this.button, Tooltip.create(LocalizationUtils.splitLocalizedStringLines(PlaceholderParser.replacePlaceholders(this.tooltip))), false, true);
//			}
//
