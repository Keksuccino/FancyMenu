package de.keksuccino.fancymenu.customization.item;
...
public abstract class CustomizationItemBase extends GuiComponent {
	...
	public CustomizationItemBase(PropertiesSection item) {
		...
		if (x != null) {
			x = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(x);
			if (MathUtils.isInteger(x)) {
				this.posX = Integer.parseInt(x);
			}
		}
		if (y != null) {
			y = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(y);
		...
		if (w != null) {
			w = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(w);
		...
		if (h != null) {
			h = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(h);
