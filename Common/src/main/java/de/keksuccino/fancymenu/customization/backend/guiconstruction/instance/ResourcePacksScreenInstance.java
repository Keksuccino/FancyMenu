package de.keksuccino.fancymenu.customization.backend.guiconstruction.instance;
...
public class ResourcePacksScreenInstance extends GuiInstance {
	...
	protected void createInstance() {
		try {
			...
			this.instance = (Screen) con.newInstance(this.findParameter(Screen.class), mc.getResourcePackRepository(), updateList, mc.getResourcePackDirectory(), Component.translatable("resourcePack.title"));
