package de.keksuccino.fancymenu.customization.loadingrequirement.v2.requirements.world;
...
public class IsMultiplayerRequirement extends LoadingRequirement {
    ...
    public String getDisplayName() {
        return Locals.localize("fancymenu.helper.editor.items.visibilityrequirements.multiplayer");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(StringUtils.splitLines(Locals.localize("fancymenu.helper.editor.items.visibilityrequirements.multiplayer.desc"), "%n%"));
    }
