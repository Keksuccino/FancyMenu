...
import de.keksuccino.fancymenu.customization.item.v2.items.IActionExecutorItem;
...
//			}
	...
	protected void updateValues() {
		...
		if (this.hoverLabelRaw != null) {
			if (!isEditorActive()) {
				this.hoverLabel = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(this.hoverLabelRaw);
			} else {
