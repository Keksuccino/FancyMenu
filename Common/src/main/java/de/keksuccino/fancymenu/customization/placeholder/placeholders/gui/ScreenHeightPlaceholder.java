...
public class ScreenHeightPlaceholder extends Placeholder {
    ...
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines(I18n.get("fancymenu.fancymenu.editor.dynamicvariabletextfield.variables.guiheight.desc")));
    }
