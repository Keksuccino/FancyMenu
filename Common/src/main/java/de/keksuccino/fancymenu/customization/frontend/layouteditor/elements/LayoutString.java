...
public class LayoutString extends AbstractEditorElement {
	...
	protected void renderBorder(PoseStack matrix, int mouseX, int mouseY) {
		...
		font.draw(matrix, Locals.localize("helper.creator.items.border.orientation")+ ": " + this.element.orientation, this.getStringPosX()*2, (this.getStringPosY()*2) - 44, Color.WHITE.getRGB());
