package de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders;

import de.keksuccino.fancymenu.customization.backend.placeholder.v2.PlaceholderRegistry;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.advanced.*;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.client.LoadedModsPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.client.MinecraftVersionPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.client.ModVersionPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.client.TotalModsPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.gui.*;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.other.RandomTextPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.other.WebTextPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.other.ram.MaxRamPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.other.ram.PercentRamPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.other.ram.UsedRamPlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.player.PlayerNamePlaceholder;
import de.keksuccino.fancymenu.customization.backend.placeholder.v2.placeholders.player.PlayerUuidPlaceholder;
