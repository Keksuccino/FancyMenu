package de.keksuccino.fancymenu.customization.item.v1;
	...
	protected void updateValues() {
		...
		if (this.action.equalsIgnoreCase("renamebutton") || this.action.equalsIgnoreCase("setbuttonlabel")) {
			if (this.labelRaw != null) {
				if (!isEditorActive()) {
					this.value = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(this.labelRaw);
				} else {
		...
		if (this.action.equals("sethoverlabel")) {
			if (this.hoverLabelRaw != null) {
				if (!isEditorActive()) {
					this.value = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(this.hoverLabelRaw);
				} else {
