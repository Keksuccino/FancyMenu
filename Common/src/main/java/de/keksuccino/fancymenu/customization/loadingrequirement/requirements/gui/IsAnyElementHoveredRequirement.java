...
public class IsAnyElementHoveredRequirement extends LoadingRequirement {
    ...
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines(I18n.get("fancymenu.helper.editor.items.visibilityrequirements.is_any_element_hovered.desc")));
    }
