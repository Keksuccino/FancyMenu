...
import de.keksuccino.fancymenu.customization.MenuCustomizationProperties;
...
import de.keksuccino.fancymenu.customization.item.v1.AnimationCustomizationItem;
import de.keksuccino.fancymenu.customization.item.v1.ButtonCustomizationItem;
import de.keksuccino.fancymenu.customization.item.CustomizationItemBase;
import de.keksuccino.fancymenu.customization.item.v1.ShapeCustomizationItem;
import de.keksuccino.fancymenu.customization.item.v1.SlideshowCustomizationItem;
import de.keksuccino.fancymenu.customization.item.v1.SplashTextCustomizationItem;
import de.keksuccino.fancymenu.customization.item.v1.StringCustomizationItem;
import de.keksuccino.fancymenu.customization.item.v1.TextureCustomizationItem;
import de.keksuccino.fancymenu.customization.item.v1.VanillaButtonCustomizationItem;
import de.keksuccino.fancymenu.customization.item.v1.WebStringCustomizationItem;
import de.keksuccino.fancymenu.customization.item.v1.WebTextureCustomizationItem;
...
public class MenuHandlerBase extends GuiComponent {
		...
		if (action != null) {
			...
			if (action.equalsIgnoreCase("setbuttondescription")) {
				if (b != null) {
					...
					if (desc != null) {
						this.sharedLayoutProps.descriptions.put(bd, de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(desc));
					}
				}
			}
	...
	public void onRenderPost(RenderScreenEvent.Post e) {
		...
		if (!this.backgroundDrawable) {
			...
			List<CustomizationItemBase> backItems = new ArrayList<>(this.backgroundRenderItems);
		...
		List<CustomizationItemBase> frontItems = new ArrayList<>(this.frontRenderItems);
	...
	protected boolean shouldCustomize(Screen menu) {
		...
		if (getMenuIdentifier() != null) {
			return this.getMenuIdentifier().equals(menu.getClass().getName());
		}
		return true;
	}
