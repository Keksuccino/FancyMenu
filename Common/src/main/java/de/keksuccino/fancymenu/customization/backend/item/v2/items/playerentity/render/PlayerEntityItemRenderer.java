package de.keksuccino.fancymenu.customization.backend.item.v2.items.playerentity.render;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.math.Axis;
import de.keksuccino.fancymenu.customization.backend.item.v2.items.playerentity.render.layers.PlayerEntityCapeLayer;
import de.keksuccino.fancymenu.customization.backend.item.v2.items.playerentity.render.layers.PlayerEntityRenderLayer;
import de.keksuccino.fancymenu.customization.backend.item.v2.items.playerentity.render.layers.PlayerEntityShoulderParrotLayer;
