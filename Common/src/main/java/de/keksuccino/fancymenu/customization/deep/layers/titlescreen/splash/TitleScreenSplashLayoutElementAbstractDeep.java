...
public class TitleScreenSplashLayoutElementAbstractDeep extends AbstractEditorDeepElement {
    ...
    public void init() {
        ...
        AdvancedButton resetOrientationButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancymenu.helper.editor.element.vanilla.deepcustomization.titlescreen.splash.orientation.reset"), true, (press) -> {
            if (!this.getSplashItem().anchorPoint.equals("original")) {
    ...
    protected TitleScreenSplashItemAbstract getSplashItem() {
        return (TitleScreenSplashItemAbstract) this.element;
    }
