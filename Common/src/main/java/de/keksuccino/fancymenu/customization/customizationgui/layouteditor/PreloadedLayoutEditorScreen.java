package de.keksuccino.fancymenu.customization.customizationgui.layouteditor;
...
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutAnimation;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutElement;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutShape;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutSlideshow;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutSplashText;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutString;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutTexture;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutWebString;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.LayoutWebTexture;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.button.LayoutButton;
import de.keksuccino.fancymenu.customization.customizationgui.layouteditor.elements.button.LayoutVanillaButton;
import de.keksuccino.fancymenu.customization.fancy.item.*;
import de.keksuccino.fancymenu.customization.item.*;
import de.keksuccino.fancymenu.customization.item.v1.*;
import de.keksuccino.fancymenu.customization.item.v1.ShapeCustomizationItem.Shape;
import de.keksuccino.fancymenu.customization.menuhandler.MenuHandlerBase;
import de.keksuccino.fancymenu.customization.fancy.menuhandler.deepcustomizationlayer.*;
import de.keksuccino.fancymenu.customization.loadingrequirement.v2.internal.LoadingRequirementContainer;
import de.keksuccino.fancymenu.customization.menuhandler.deepcustomizationlayer.*;
					...
					if (action.equalsIgnoreCase("texturizebackground")) {
						...
						if (value != null) {
							...
							if (f.exists() && f.isFile() && (f.getName().toLowerCase().endsWith(".jpg") || f.getName().toLowerCase().endsWith(".jpeg") || f.getName().toLowerCase().endsWith(".png"))) {
								this.backgroundTexture = TextureHandler.getResource(valueFinal);
