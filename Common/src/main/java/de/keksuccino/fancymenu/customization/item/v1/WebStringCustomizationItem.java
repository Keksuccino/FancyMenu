	...
	public WebStringCustomizationItem(PropertiesSection item) {
		...
		if ((this.action != null) && this.action.equalsIgnoreCase("addwebtext")) {
			...
			if (this.value != null) {
				...
				this.value = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(this.value);
			}
					...
					try {
						...
						while(s != null) {
							if (isEditorActive()) {
								...
								s = de.keksuccino.fancymenu.customization.placeholder.v2.PlaceholderParser.replacePlaceholders(s);
							}
