package de.keksuccino.fancymenu.customization.backend.button.identification;

import de.keksuccino.fancymenu.customization.backend.button.ButtonData;
import de.keksuccino.fancymenu.customization.backend.button.identification.identificationcontext.DeathScreenButtonsIdentificationContext;
import de.keksuccino.fancymenu.customization.backend.button.identification.identificationcontext.MenuButtonsIdentificationContext;
import de.keksuccino.fancymenu.customization.backend.button.identification.identificationcontext.PauseScreenButtonsIdentificationContext;
import de.keksuccino.fancymenu.customization.backend.button.identification.identificationcontext.TitleScreenButtonsIdentificationContext;
