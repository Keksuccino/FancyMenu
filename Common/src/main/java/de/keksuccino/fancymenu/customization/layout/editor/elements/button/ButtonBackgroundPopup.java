...
public class ButtonBackgroundPopup extends FMPopup {
    ...
    public ButtonBackgroundPopup(int backgroundAlpha) {
...
//                I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.image"),
//                I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation")
//        );
...
//            this.normalBackgroundTypeSwitcher.setSelectedValue(I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation"));
//        }
//
...
//            this.hoverBackgroundTypeSwitcher.setSelectedValue(I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation"));
//        }
//
//        List<String> aniList = new ArrayList<String>();
//        aniList.add("-- " + I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation.none") + " --");
...
//                    this.normalBackgroundAnimationSwitcher.setSelectedValue("-- " + I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation.none") + " --");
//                }
//            }
//        }
...
//                    this.hoverBackgroundAnimationSwitcher.setSelectedValue("-- " + I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation.none") + " --");
//                }
//            }
//        }
...
//        }
//
//        this.chooseNormalBackgroundImageButton = new AdvancedButton(0, 0, 100, 20, I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.image.chooseimage"), true, (press) -> {
...
//                                    PopupHandler.displayPopup(this);
//                                }, I18n.get("fancymenu.editor.textures.invalidcharacters"), "", "", "", "", "", "");
...
//                        FMNotificationPopup pop = new FMNotificationPopup(300, new Color(0,0,0,0), 240, () -> {
//                            PopupHandler.displayPopup(this);
//                        }, "§c§l" + I18n.get("fancymenu.editor.invalidimage.title"), "", I18n.get("fancymenu.editor.invalidimage.desc"), "", "", "", "", "", "");
//                        PopupHandler.displayPopup(pop);
//                    }
//                } else {
//                    PopupHandler.displayPopup(this);
...
//
//        this.chooseHoverBackgroundImageButton = new AdvancedButton(0, 0, 100, 20, I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.image.chooseimage"), true, (press) -> {
//            ChooseFilePopup cf = new ChooseFilePopup((call) -> {
//                if (call != null) {
//                    File home = Minecraft.getInstance().gameDirectory;
//                    call = call.replace("\\", "/");
...
//
//        this.doneButton = new AdvancedButton(0, 0, 100, 20, I18n.get("fancymenu.guicomponents.done"), true, (call) -> {
...
//
//        this.cancelButton = new AdvancedButton(0, 0, 100, 20, I18n.get("fancymenu.guicomponents.cancel"), true, (call) -> {
//            if (this.onClose != null) {
//                this.onClose.run();
//            }
//            this.setDisplayed(false);
...
//
//        //Normal Background
//        drawCenteredString(matrix, font, "§l" + I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.normalbackground"), midX, midY - 113, -1);
//
//        this.normalBackgroundTypeSwitcher.render(matrix, midX - (this.normalBackgroundTypeSwitcher.getTotalWidth() / 2), midY - 100);
//
//        if (this.normalBackgroundTypeSwitcher.getSelectedValue().equals(I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.image"))) {
//
...
//
//        } else if (this.normalBackgroundTypeSwitcher.getSelectedValue().equals(I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation"))) {
//
...
//
//        //Hover Background
//        drawCenteredString(matrix, font, "§l" + I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.hoverbackground"), midX, midY - 15, -1);
//
//        this.hoverBackgroundTypeSwitcher.render(matrix, midX - (this.hoverBackgroundTypeSwitcher.getTotalWidth() / 2), midY - 2); // 98
//
//        if (this.hoverBackgroundTypeSwitcher.getSelectedValue().equals(I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.image"))) {
//
...
//
//        } else if (this.hoverBackgroundTypeSwitcher.getSelectedValue().equals(I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation"))) {
//
...
//            }
//        } else if (this.normalBackgroundTypeSwitcher.getSelectedValue().equals(I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation"))) {
//            if (!this.normalBackgroundAnimationSwitcher.getSelectedValue().equals("-- " + I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation.none") + " --")) {
...
//            }
//        } else if (this.hoverBackgroundTypeSwitcher.getSelectedValue().equals(I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation"))) {
//            if (!this.hoverBackgroundAnimationSwitcher.getSelectedValue().equals("-- " + I18n.get("fancymenu.helper.editor.items.buttons.buttonbackground.type.animation.none") + " --")) {
