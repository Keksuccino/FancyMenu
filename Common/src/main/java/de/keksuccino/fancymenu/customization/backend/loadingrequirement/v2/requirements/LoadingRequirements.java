...
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.gui.IsElementHoveredRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.gui.IsGuiScaleRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.gui.IsLayoutEnabledRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.system.IsOsLinuxRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.system.IsOsMacOSRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.system.IsOsWindowsRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.world.IsMultiplayerRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.world.IsSingleplayerRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.world.IsWorldLoadedRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.world.gamemode.IsAdventureRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.world.gamemode.IsCreativeRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.world.gamemode.IsSpectatorRequirement;
import de.keksuccino.fancymenu.customization.backend.loadingrequirement.v2.requirements.world.gamemode.IsSurvivalRequirement;
