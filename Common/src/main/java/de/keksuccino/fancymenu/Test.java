...
public class Test {
    ...
    public void onInit(InitOrResizeScreenCompletedEvent e) {
        ...
        contextMenu.addClickableEntry("entry_2", Component.literal("Entry 2 loooooong iuiuiuiuiuiuiu"), ((menu, entry) -> LOGGER.info("CLICK"))).setShortcutText(Component.literal("Ctrl+Alt+C"));
        ...
        subMenu1.addClickableEntry("entry_3", Component.literal("Entry 3"), (menu, entry) -> LOGGER.info("CLICK")).setShortcutText(Component.literal("Ctrl+C"));
        contextMenu.addEntry(new ContextMenu.SubMenuContextMenuEntry("sub_1", contextMenu, Component.literal("Sub Menu 1"), subMenu1));
        contextMenu.addClickableEntry("entry_5", Component.literal("Entry 5"), ((menu, entry) -> LOGGER.info("CLICK"))).setShortcutText(Component.literal("Alt+G")).setActive(false);
