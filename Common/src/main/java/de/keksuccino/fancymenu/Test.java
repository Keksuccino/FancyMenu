...
public class Test {
    ...
    public void onRenderPost(RenderScreenEvent.Post e) {
        ...
        if (contextMenu == null) {
            ...
            contextMenu.addClickableEntry("entry_2", Component.literal("Entry 2 loooooong"), ((menu, entry) -> LOGGER.info("CLICK")));
            ...
            subMenu1.addClickableEntry("entry_3", Component.literal("Entry 3"), (menu, entry) -> LOGGER.info("CLICK"));
            contextMenu.addEntry(new ContextMenu.SubMenuContextMenuEntry("sub_1", contextMenu, Component.literal("Sub Menu 1   >"), subMenu1));
            contextMenu.addClickableEntry("entry_5", Component.literal("Entry 5"), ((menu, entry) -> LOGGER.info("CLICK")));
