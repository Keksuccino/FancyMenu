...
//public class ContextMenuOri extends GuiComponent implements Renderable, GuiEventListener, NarratableEntry {
//
...
//
//    @NotNull
//    public SubMenuContextMenuEntry addSubMenuEntryAt(int index, @NotNull String identifier, @NotNull Component label, @NotNull ContextMenuOri subContextMenu) {
//        SubMenuContextMenuEntry e = new SubMenuContextMenuEntry(identifier, this, label, subContextMenu);
//        return this.addEntryAt(index, e);
//    }
//
//    @NotNull
//    public SubMenuContextMenuEntry addSubMenuEntryBefore(@NotNull String addBeforeIdentifier, @NotNull String identifier, @NotNull Component label, @NotNull ContextMenuOri subContextMenu) {
//        SubMenuContextMenuEntry e = new SubMenuContextMenuEntry(identifier, this, label, subContextMenu);
//        return this.addEntryBefore(addBeforeIdentifier, e);
//    }
//
//    @NotNull
//    public SubMenuContextMenuEntry addSubMenuEntryAfter(@NotNull String addAfterIdentifier, @NotNull String identifier, @NotNull Component label, @NotNull ContextMenuOri subContextMenu) {
//        SubMenuContextMenuEntry e = new SubMenuContextMenuEntry(identifier, this, label, subContextMenu);
//        return this.addEntryAfter(addAfterIdentifier, e);
//    }
//
//    @NotNull
//    public SubMenuContextMenuEntry addSubMenuEntry(@NotNull String identifier, @NotNull Component label, @NotNull ContextMenuOri subContextMenu) {
//        SubMenuContextMenuEntry e = new SubMenuContextMenuEntry(identifier, this, label, subContextMenu);
...
//    }
//
//    public ContextMenuOri removeEntry(String identifier) {
...
//    }
//
//    public ContextMenuOri clearEntries() {
//        this.closeMenu();
//        for (ContextMenuEntry e : this.entries) {
//            e.onRemoved();
//        }
...
//    }
//
//    public ContextMenuOri setScale(float scale) {
...
//    }
//
//    public ContextMenuOri setOverriddenRenderScale(@Nullable Float overriddenRenderScale) {
...
//    }
//
//    public ContextMenuOri setOverriddenTooltipScale(@Nullable Float overriddenTooltipScale) {
...
//    }
//
//    public ContextMenuOri setForceUIScale(boolean forceUIScale) {
...
//    }
//
//    protected ContextMenuOri unhoverAllEntries() {
//        for (ContextMenuEntry e : this.entries) {
//            e.setHovered(false);
//        }
//        return this;
...
//    }
//
//    public ContextMenuOri setShadow(boolean shadow) {
//        this.shadow = shadow;
//        return this;
//    }
//
...
//    }
//
//    public ContextMenuOri setForceDefaultTooltipStyle(boolean forceDefaultTooltipStyle) {
...
//    }
//
//    public ContextMenuOri setKeepDistanceToEdges(boolean keepDistanceToEdges) {
...
//    }
//
//    public ContextMenuOri setForceRawXY(boolean forceRawXY) {
...
//    }
//
//    public ContextMenuOri setForceSide(boolean forceSide) {
...
//    }
//
//    public ContextMenuOri setSubMenuOpeningSide(@NotNull SubMenuOpeningSide subMenuOpeningSide) {
...
//    }
//
//    public ContextMenuOri openMenuAt(int x, int y) {
//        this.closeSubMenus();
...
//    }
//
//    public ContextMenuOri openMenuAtMouse() {
//        return this.openMenuAt(MouseInput.getMouseX(), MouseInput.getMouseY());
//    }
//
//    public ContextMenuOri closeMenu() {
//        this.closeSubMenus();
//        this.unhoverAllEntries();
//        this.open = false;
//        return this;
//    }
//
//    public ContextMenuOri closeSubMenus() {
//        for (ContextMenuEntry e : this.entries) {
//            if (e instanceof SubMenuContextMenuEntry s) {
...
//
//    /**
//     * Will stack all stackable settings and all stackable ACTIVE {@link ContextMenuEntry}s of the given {@link ContextMenuOri}s and returns them as a new (stacked) instance.
//     */
//    @NotNull
//    public static ContextMenuOri stackContextMenus(@NotNull List<ContextMenuOri> menusToStack) {
//        return stackContextMenus(menusToStack.toArray(new ContextMenuOri[0]));
//    }
//
//    /**
//     * Will stack all stackable settings and all stackable ACTIVE {@link ContextMenuEntry}s of the given {@link ContextMenuOri}s and returns them as a new (stacked) instance.
//     */
//    @NotNull
//    public static ContextMenuOri stackContextMenus(@NotNull ContextMenuOri... menusToStack) {
//
//        ContextMenuOri stacked = new ContextMenuOri();
//
...
//    }
//
//    protected static List<ContextMenuEntry> collectInstancesOfStackableEntryInMenus(String entryIdentifier, ContextMenuOri[] menus) {
//        List<ContextMenuEntry> entries = new ArrayList<>();
//        for (ContextMenuOri m : menus) {
...
//    }
//
//    protected static List<ContextMenuOri> getSubContextMenusOfSubMenuEntries(List<ContextMenuEntry> entries) {
//        List<ContextMenuOri> l = new ArrayList<>();
...
//        protected ContextMenuOri parent;
//        /** Only for internal use. This gets set by the parent {@link ContextMenuOri}. **/
//        protected int x;
//        /** Only for internal use. This gets set by the parent {@link ContextMenuOri}. **/
//        protected int y;
//        /** Only for internal use. This gets set by the parent {@link ContextMenuOri}. **/
...
//
//        public ContextMenuEntry(@NotNull String identifier, @NotNull ContextMenuOri parent) {
...
//
//        @NotNull
//        public ContextMenuOri getParent() {
//            return parent;
//        }
//
//        public int getHeight() {
...
//            /**
//             * @param menu The {@link ContextMenuOri} this {@link EntryTask}'s {@link ContextMenuEntry} is part of.
...
//             */
//            void run(ContextMenuOri menu, ContextMenuEntry entry, boolean isPost);
//        }
//
//    }
//
...
//
//        public ClickableContextMenuEntry(@NotNull String identifier, @NotNull ContextMenuOri parent, @NotNull Component label, @NotNull ClickAction clickAction) {
...
//        }
//
//        public ClickableContextMenuEntry setIcon(@Nullable ResourceLocation icon) {
//            this.icon = icon;
//            return this;
//        }
//
...
//            void onClick(ContextMenuOri menu, ClickableContextMenuEntry entry);
//        }
//
//    }
//
...
//
//        public ValueCycleContextMenuEntry(@NotNull String identifier, @NotNull ContextMenuOri parent, @NotNull ILocalizedValueCycle<T> valueCycle) {
...
//
//        @NotNull
//        protected ContextMenuOri subContextMenu;
...
//
//        public SubMenuContextMenuEntry(@NotNull String identifier, @NotNull ContextMenuOri parent, @NotNull Component label, @NotNull ContextMenuOri subContextMenu) {
...
//
//        @NotNull
//        public ContextMenuOri getSubContextMenu() {
//            return this.subContextMenu;
//        }
//
//        public void setSubContextMenu(@NotNull ContextMenuOri subContextMenu) {
//            this.subContextMenu.closeMenu();
...
//            SubMenuContextMenuEntry copy = new SubMenuContextMenuEntry(this.identifier, this.parent, Component.literal(""), new ContextMenuOri());
//            copy.height = this.height;
//            copy.tickAction = this.tickAction;
//            copy.tooltipSupplier = this.tooltipSupplier;
//            copy.activeStateSupplier = this.activeStateSupplier;
...
//
//        @Override
//        public SubMenuContextMenuEntry setIcon(@Nullable ResourceLocation icon) {
//            return (SubMenuContextMenuEntry) super.setIcon(icon);
//        }
//
//        @Override
...
//
//        public SeparatorContextMenuEntry(@NotNull String identifier, @NotNull ContextMenuOri parent) {
//            super(identifier, parent);
//            this.height = 9;
//        }
//
...
//
//        public SpacerContextMenuEntry(@NotNull String identifier, @NotNull ContextMenuOri parent) {
//            super(identifier, parent);
//            this.height = 4;
//        }
//
...
//        T get(ContextMenuOri menu, ContextMenuEntry entry);
//    }
//
//    @FunctionalInterface
//    public interface BooleanSupplier extends Supplier<Boolean> {
//
//        default boolean getBoolean(ContextMenuOri menu, ContextMenuEntry entry) {
