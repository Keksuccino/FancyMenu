...
public class MenuBar extends UIBase {
	...
	public static final ResourceLocation FM_LOGO_TEXTURE = new ResourceLocation("keksuccino", "fancymenu_logo.png");
			...
			if (this.visible) {
				...
				if (this.expanded) {
					...
					if (right != null) {
						...
						right.y = 0;
						applyDefaultWidgetSkinTo(right);
