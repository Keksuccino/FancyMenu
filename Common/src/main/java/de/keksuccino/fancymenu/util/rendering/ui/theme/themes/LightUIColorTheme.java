...
public class LightUIColorTheme extends UIColorTheme {
    ...
    public LightUIColorTheme() {
        ...
        screen_background_color = DrawableColor.of(new Color(206, 206, 206));
        ...
        element_background_color_normal = DrawableColor.of(new Color(213, 213, 213));
        element_background_color_hover = DrawableColor.of(new Color(83, 156, 212));
        area_background_color = DrawableColor.of(new Color(180, 180, 180));
        list_entry_color_selected_hovered = DrawableColor.of(new Color(164, 164, 164));
        ...
        element_label_color_inactive = DrawableColor.of(new Color(154, 154, 154));
        description_area_text_color = DrawableColor.of(new Color(72, 78, 83));
