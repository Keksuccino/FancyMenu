...
public class ChooseFilePopup extends TextInputPopup {
	...
	public void render(MatrixStack matrix, int mouseX, int mouseY, Screen renderIn) {
		...
		this.doneButton.setY(((renderIn.height  / 2) + 100) - this.doneButton.func_238483_d_() - 5);
		
		this.chooseFileBtn.setX((renderIn.width / 2) - (this.doneButton.getWidth() / 2));
		this.chooseFileBtn.setY(((renderIn.height  / 2) + 50) - this.doneButton.func_238483_d_() - 5);
