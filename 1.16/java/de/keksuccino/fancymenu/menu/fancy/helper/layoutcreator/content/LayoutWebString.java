...
public class LayoutWebString extends LayoutObject {
	...
	protected void renderBorder(MatrixStack matrix, int mouseX, int mouseY) {
		...
		font.func_238405_a_(matrix, Locals.localize("helper.creator.items.border.orientation")+ ": " + this.object.orientation, this.getStringPosX()*2, (this.getStringPosY()*2) - 35, Color.WHITE.getRGB());
