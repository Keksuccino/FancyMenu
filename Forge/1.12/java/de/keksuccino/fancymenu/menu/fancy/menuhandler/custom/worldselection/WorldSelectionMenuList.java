...
public class WorldSelectionMenuList extends GuiListWorldSelection {

	private MenuHandlerBase handler;
	private GuiScreen screen;
	
	public WorldSelectionMenuList(GuiWorldSelection p_i46590_1_, Minecraft clientIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn, MenuHandlerBase handler) {
		super(p_i46590_1_, clientIn, widthIn, heightIn, topIn, bottomIn, slotHeightIn);
		this.handler = handler;
		this.screen = p_i46590_1_;
	}
