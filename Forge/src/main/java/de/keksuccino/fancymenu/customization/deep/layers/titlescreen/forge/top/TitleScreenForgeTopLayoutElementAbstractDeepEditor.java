...
public class TitleScreenForgeTopLayoutElementAbstractDeepEditor extends AbstractDeepEditorElement {

    public TitleScreenForgeTopLayoutElementAbstractDeepEditor(@NotNull DeepElementBuilder parentDeepElementBuilder, @NotNull AbstractDeepElement customizationItemInstance, @NotNull LayoutEditorScreen handler) {
