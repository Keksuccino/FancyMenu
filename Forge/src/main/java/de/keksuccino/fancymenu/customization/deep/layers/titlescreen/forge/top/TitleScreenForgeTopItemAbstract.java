...
public class TitleScreenForgeTopItemAbstract extends AbstractDeepElement {

    public TitleScreenForgeTopItemAbstract(DeepElementBuilder parentElement, PropertyContainer item) {
