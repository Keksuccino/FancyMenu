	...
	public void render() {
		if (this.prepared) {
			...
			if (this.overlay_texture != null) {
				...
				blit(0, 0, 0.0F, 0.0F, Minecraft.getInstance().currentScreen.width, Minecraft.getInstance().currentScreen.height, Minecraft.getInstance().currentScreen.width, Minecraft.getInstance().currentScreen.height);
			}
