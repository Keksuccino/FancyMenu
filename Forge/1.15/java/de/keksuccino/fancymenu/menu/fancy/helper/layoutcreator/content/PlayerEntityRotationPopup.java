...
public class PlayerEntityRotationPopup extends Popup {
	...
	public void render(int mouseX, int mouseY, Screen renderIn) {
		...
		this.bodyX.render(mouseX, mouseY, partial);
		...
		this.bodyY.render(mouseX, mouseY, partial);
		...
		this.headX.render(mouseX, mouseY, partial);
		...
		this.headY.render(mouseX, mouseY, partial);
