...
public class EditHistory {
	...
	public void render() {
		if (this.editor.expanded && (this.editor.addObjectButton != null)) {
			...
			this.backBtn.xPosition = addBtn.xPosition;
			this.backBtn.yPosition = addBtn.yPosition - this.backBtn.height - 2;
			
			this.forwardBtn.xPosition = this.backBtn.xPosition + this.backBtn.width + 2;
			this.forwardBtn.yPosition = addBtn.yPosition - this.backBtn.height - 2;
			
			this.backBtn.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
			this.forwardBtn.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
		}
	}
