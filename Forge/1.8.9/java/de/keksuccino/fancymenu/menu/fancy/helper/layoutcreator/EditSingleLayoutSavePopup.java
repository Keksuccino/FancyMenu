	...
	public void render(int mouseX, int mouseY, GuiScreen renderIn) {
		...
		if (this.isDisplayed()) {
			...
			for (String s : this.text) {
				renderIn.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, s, renderIn.width / 2, (renderIn.height / 2) - 50 + i, Color.WHITE.getRGB());
				i += 10;
			}
			
			this.overrideButton.xPosition = (renderIn.width / 2) - (this.overrideButton.width / 2);
			this.overrideButton.yPosition = ((renderIn.height / 2));
			
			this.saveAndKeepOthersButton.xPosition = (renderIn.width / 2) - (this.saveAndKeepOthersButton.width / 2);
			this.saveAndKeepOthersButton.yPosition = ((renderIn.height / 2) + 25);
			
			this.saveAndDisableOthersButton.xPosition = (renderIn.width / 2) - (this.saveAndDisableOthersButton.width / 2);
			this.saveAndDisableOthersButton.yPosition = ((renderIn.height / 2) + 50);
			
			this.cancelButton.xPosition = (renderIn.width / 2) - (this.cancelButton.width / 2);
			this.cancelButton.yPosition = ((renderIn.height / 2) + 75);
