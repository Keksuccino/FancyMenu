...
public class WindowSizePopup extends Popup {
	...
	public WindowSizePopup(LayoutCreatorScreen parent, ActionType type) {
		...
		this.widthText = new AdvancedTextField(Minecraft.getMinecraft().fontRendererObj, 0, 0, 200, 20, true, CharacterFilter.getIntegerCharacterFiler());
		...
		this.heightText = new AdvancedTextField(Minecraft.getMinecraft().fontRendererObj, 0, 0, 200, 20, true, CharacterFilter.getIntegerCharacterFiler());
		if (type == ActionType.BIGGERTHAN) {
	...
	public void render(int mouseX, int mouseY, GuiScreen renderIn) {
		...
		this.widthText.xPosition = (renderIn.width / 2) - (this.widthText.getWidth() / 2);
		this.widthText.yPosition = (renderIn.height / 2) - 65;
		...
		this.heightText.xPosition = (renderIn.width / 2) - (this.heightText.getWidth() / 2);
		this.heightText.yPosition = (renderIn.height / 2) - 22;
		...
		this.doneButton.xPosition = (renderIn.width / 2) - this.doneButton.width - 5;
		this.doneButton.yPosition = (renderIn.height / 2) + 80;
		
		this.cancelButton.xPosition = (renderIn.width / 2) + 5;
		this.cancelButton.yPosition = (renderIn.height / 2) + 80;
