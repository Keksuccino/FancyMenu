...
public class LayoutSavePopup extends Popup {
	...
	public void render(int mouseX, int mouseY, GuiScreen renderIn) {
		...
		if (this.isDisplayed()) {
			...
			this.saveButton.xPosition = (renderIn.width / 2) - (this.saveButton.width / 2);
			this.saveButton.yPosition = ((renderIn.height / 2) + (height / 2));
			
			this.saveAndDisableOthersButton.xPosition = (renderIn.width / 2) - (this.saveAndDisableOthersButton.width / 2);
			this.saveAndDisableOthersButton.yPosition = ((renderIn.height / 2) + (height / 2) + 25);
			
			this.cancelButton.xPosition = (renderIn.width / 2) - (this.cancelButton.width / 2);
			this.cancelButton.yPosition = ((renderIn.height / 2) + (height / 2) + 50);
