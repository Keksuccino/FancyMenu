...
public class HideForPopup extends TextInputPopup {
	...
	public void render(int mouseX, int mouseY, GuiScreen renderIn) {
		...
		this.delayEverytimeBtn.xPosition = (renderIn.width / 2) - this.delayEverytimeBtn.width - 5;
		this.delayEverytimeBtn.yPosition = ((renderIn.height  / 2) + 50) - this.delayEverytimeBtn.height - 5;
		
		this.delayOnlyFirstTimeBtn.xPosition = (renderIn.width / 2) + 5;
		this.delayOnlyFirstTimeBtn.yPosition = ((renderIn.height  / 2) + 50) - this.delayOnlyFirstTimeBtn.height - 5;
		
		this.doneButton.xPosition = (renderIn.width / 2) - (this.doneButton.width / 2);
		this.doneButton.yPosition = ((renderIn.height / 2) + 90) - this.doneButton.height - 5;
