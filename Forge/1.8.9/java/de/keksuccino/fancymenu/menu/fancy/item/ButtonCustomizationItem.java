...
public class ButtonCustomizationItem extends CustomizationItemBase {
	...
	public void render(GuiScreen menu) throws IOException {
		...
		if (this.onlyOutgame && (Minecraft.getMinecraft().theWorld != null)) {
			return;
		}

		if (this.onlyMultiplayer && ((Minecraft.getMinecraft().theWorld == null) || Minecraft.getMinecraft().isSingleplayer())) {
			return;
		}

		if (this.onlySingleplayer && ((Minecraft.getMinecraft().theWorld == null) || !Minecraft.getMinecraft().isSingleplayer())) {
			return;
		}
		...
		this.button.drawButton(Minecraft.getMinecraft(), MouseInput.getMouseX(), MouseInput.getMouseY());
	}
