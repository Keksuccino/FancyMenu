...
public class BackgroundOptionsPopup extends Popup {
	...
	public void render(int mouseX, int mouseY, GuiScreen renderIn) {
		...
		if (this.isDisplayed()) {
			...
			renderIn.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, "§l" + Locals.localize("helper.creator.backgroundoptions"), renderIn.width / 2, (renderIn.height / 2) - 110, Color.WHITE.getRGB());
			...
			if (s.equals(Locals.localize("helper.creator.backgroundoptions.backgroundanimation"))) {
				...
				renderIn.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, Locals.localize("helper.creator.backgroundoptions.animations"), renderIn.width / 2, (renderIn.height / 2) - 50, Color.WHITE.getRGB());
				
				this.animationSwitcher.render((renderIn.width / 2) - (this.animationSwitcher.getTotalWidth() / 2), (renderIn.height / 2) - 35);
				
				if (this.animationSwitcher.getSelectedValue() != null) {
					this.addRemoveAnimationButton.xPosition = (renderIn.width / 2) - (this.addRemoveAnimationButton.width / 2);
					this.addRemoveAnimationButton.yPosition = (renderIn.height / 2) - 5;
					if (this.handler.backgroundAnimationNames.contains(this.animationSwitcher.getSelectedValue())) {
				...
				renderIn.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, Locals.localize("helper.creator.backgroundoptions.randomizeanimations"), renderIn.width / 2, (renderIn.height / 2) + 30, Color.WHITE.getRGB());
				
				this.randomButton.xPosition = (renderIn.width / 2) - this.randomButton.width - 5;
				this.randomButton.yPosition = (renderIn.height / 2) + 45;
				this.randomButton.visible = true;
				
				this.notRandomButton.xPosition = (renderIn.width / 2) + 5;
				this.notRandomButton.yPosition = (renderIn.height / 2) + 45;
			...
			if (s.equals(Locals.localize("helper.creator.backgroundoptions.backgroundimage"))) {
				this.chooseTextureButton.xPosition = (renderIn.width / 2) - (this.chooseTextureButton.width / 2);
				this.chooseTextureButton.yPosition = (renderIn.height / 2) - 25;
				this.chooseTextureButton.visible = true;

				renderIn.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, Locals.localize("helper.creator.backgroundoptions.setpanorama"), renderIn.width / 2, (renderIn.height / 2) + 13, Color.WHITE.getRGB());

				this.panoramaButton.xPosition = (renderIn.width / 2) - this.panoramaButton.width - 5;
				this.panoramaButton.yPosition = (renderIn.height / 2) + 30;
				this.panoramaButton.visible = true;

				this.noPanoramaButton.xPosition = (renderIn.width / 2) + 5;
				this.noPanoramaButton.yPosition = (renderIn.height / 2) + 30;
			...
			if (s.equals(Locals.localize("helper.creator.backgroundoptions.backgroundpanorama"))) {
				...
				renderIn.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, Locals.localize("helper.creator.backgroundoptions.panoramas"), renderIn.width / 2, (renderIn.height / 2) - 50, Color.WHITE.getRGB());
				
				this.panoramaSwitcher.render((renderIn.width / 2) - (this.panoramaSwitcher.getTotalWidth() / 2), (renderIn.height / 2) - 35);
				
				this.setPanoramaButton.xPosition = (renderIn.width / 2) - (this.setPanoramaButton.width / 2);
				this.setPanoramaButton.yPosition = (renderIn.height / 2) - 5;
				
				this.clearPanoramaButton.xPosition = (renderIn.width / 2) - (this.clearPanoramaButton.width / 2);
				this.clearPanoramaButton.yPosition = (renderIn.height / 2) + 20;
			...
			this.doneButton.yPosition = (renderIn.height / 2) + 85;
