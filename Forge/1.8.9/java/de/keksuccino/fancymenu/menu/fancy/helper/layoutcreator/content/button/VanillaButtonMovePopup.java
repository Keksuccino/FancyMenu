...
public class VanillaButtonMovePopup extends NotificationPopup {
	...
	public void render(int mouseX, int mouseY, GuiScreen renderIn) {
		...
		this.dontShowAgainBtn.xPosition = (renderIn.width / 2) - (this.dontShowAgainBtn.width / 2);
		this.dontShowAgainBtn.yPosition = this.accept.yPosition + 20 + 15;
		this.dontShowAgainBtn.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
	}
