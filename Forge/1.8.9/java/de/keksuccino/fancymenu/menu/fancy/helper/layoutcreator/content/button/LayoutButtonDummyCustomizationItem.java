...
public class LayoutButtonDummyCustomizationItem  extends CustomizationItemBase {
	...
	public void render(GuiScreen menu) throws IOException {
        ...
        menu.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, this.value, this.getPosX(menu) + this.width / 2, this.getPosY(menu) + (this.height - 8) / 2, new Color(255, 255, 255, 255).getRGB());
