...
@Mod(modid = "fancymenu", acceptedMinecraftVersions="[1.8.9]", dependencies = "after:findme;required-after:konkrete@[1.1.0.1,]", clientSideOnly = true)
public class FancyMenu {
	
	public static final String VERSION = "1.6.0.1";
