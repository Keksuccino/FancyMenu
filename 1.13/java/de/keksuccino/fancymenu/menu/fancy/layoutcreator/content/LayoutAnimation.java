...
public class LayoutAnimation extends LayoutObject {
	...
	public LayoutAnimation(CustomizationItemBase parent) {
		...
		if (!parent.action.equalsIgnoreCase("addanimation")) {
			throw new IllegalArgumentException("Customization item is not an animation!");
		}
	}
	...
	public void render(int mouseX, int mouseY) {
		...
		if (!this.item.action.equalsIgnoreCase("addanimation")) {
			return;
		}
