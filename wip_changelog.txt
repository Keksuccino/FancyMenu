...
- You can now set buttons and sliders to have transparent backgrounds (without the need to set transparent textures)
- You can now set buttons and sliders to underline their label on hover (without setting a "hover label")
- You can now set a label hover color for buttons and sliders to change the label's color when button/slider is hovered (without setting a "hover label")
...
- Fixed "Replace Text" placeholder can’t replace literal "\" characters (#1456)
...
- Fixed audio files loaded via resource pack stop working (or play really quiet) when joining a world (#1463)
